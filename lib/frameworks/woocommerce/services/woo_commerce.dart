  ...
  Future<Map<String, dynamic>> getCustomerInfo(String? id) async {
    try {
      ...
      if (response['billing'] != null) {
        ...
        billing.firstName = billing.firstName!.isEmpty
            ? address.firstName
            : billing.firstName;
        billing.lastName = billing.lastName!.isEmpty
            ? address.lastName
            : billing.lastName;
    ...
    try {
      ...
      final result = await wcConnector.httpPost(
        ...
        body: jsonEncode({
          ...
          'orderId': orderId,
          if (isSplitPayment != null) 'isSplitPayment': isSplitPayment,
        }),
        headers: {'content-type': 'application/json'},
      );
