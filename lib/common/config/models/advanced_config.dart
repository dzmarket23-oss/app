...
class AdvancedConfig {
  ...
  Currency? get defaultCurrency => _defaultCurrency ?? currencies.firstOrNull;
    ...
    return AdvancedConfig(
      ...
      currencies: <Currency>[
        ...((json['Currencies'] is List
                    ? json['Currencies']
                    : DefaultConfig.advanceConfig['Currencies'] ?? [])
                as List)
      ...
      enableWOOCSCurrencySwitcher:
          json['EnableWOOCSCurrencySwitcher'] ??
      ...
      enableDigitsMobileLogin:
          json['EnableDigitsMobileLogin'] ??
          DefaultConfig.advanceConfig['EnableDigitsMobileLogin'],
      enableDigitsMobileFirebase:
          json['EnableDigitsMobileFirebase'] ??
          DefaultConfig.advanceConfig['EnableDigitsMobileFirebase'],
      enableDigitsMobileWhatsApp:
          json['EnableDigitsMobileWhatsApp'] ??
      ...
      enableTeraWalletWithdrawal:
          json['EnableTeraWalletWithdrawal'] ??
