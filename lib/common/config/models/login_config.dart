...
class LoginConfig {
  ...
  bool showSocialInRegistration = false;
  ...
  /// Check if any social login option is enabled
  bool get isAnySocialLoginEnabled =>
      showFacebook || showSMSLogin || showGoogleLogin || showAppleLogin;
  ...
  LoginConfig.fromJson(dynamic json) {
    ...
    showSocialInRegistration = json['showSocialInRegistration'] ?? false;
  ...
  LoginConfig copyWith({
    ...
    return LoginConfig(
      ...
      showSocialInRegistration:
          showSocialInRegistration ?? this.showSocialInRegistration,
  ...
  Map toJson() {
    ...
    map['showSocialInRegistration'] = showSocialInRegistration;
