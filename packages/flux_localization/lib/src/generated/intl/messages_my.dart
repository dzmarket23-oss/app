...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "သင်၏ Razorpay အကောင့်တွင် ${currency} ငွေကြေးကို မပံ့ပိုးပါ။ နိုင်ငံတကာငွေပေးချေမှုကို ဖွင့်ရန် သို့မဟုတ် ပံ့ပိုးထားသော ငွေကြေးသို့ ပြောင်းရန် support ကို ဆက်သွယ်ပါ။";

  static String m20(day) => "${day} ရက်အကြာ";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => " ${timeLeft}တွင် ပြီးဆုံးသည် ";

  static String m23(captcha) => "အတည်ပြုရန် ${captcha} ကိုထည့်ပါ-";

  static String m24(message) => "အမှား- ${message}";

  static String m25(message) => "အမှား- ${message}";

  static String m26(error) => "အမှားတစ်ခု ဖြစ်ပွားခဲ့သည်: ${error}";

  static String m27(error) => "အမှားတစ်ခု ဖြစ်ပွားခဲ့သည်: ${error}";

  static String m28(time) => " ${time}တွင် သက်တမ်းကုန်မည် ";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} နာရီအကြာ";
  ...
  static String m34(size) => "အများဆုံး ဖိုင်အရွယ်အစား- ${size} MB";
  ...
  static String m37(count) => "အနည်းဆုံး ${count} အက္ခရာ လိုအပ်သည်";

  static String m38(storeName, minOrderAmount) =>
  ...
  static String m40(value) => "အနည်းဆုံး ငွေပေးငွေယူ- ${value}";

  static String m41(minute) => "${minute} မိနစ်အကြာ";

  static String m42(month) => "${month} လအကြာက";

  static String m43(store) => " ${store}မှ နောက်ထပ်";

  static String m44(number) => " ${number}အုပ်စုဖြင့် ဝယ်ယူရမည်";

  static String m45(itemCount) => "ပစ္စည်း ${itemCount} ခု";

  static String m46(price) => "ရွေးချယ်စရာများ စုစုပေါင်း- ${price}";

  static String m47(amount) => " ${amount}ပေးချေပါ";

  static String m48(name) =>
      "${name} ကို လှည်းသို့ အောင်မြင်စွာ ပေါင်းထည့်လိုက်ပါပြီ။";

  static String m49(total) => "Qty: ${total}";

  static String m50(name) => " ${name}ထံမှ ငွေလက်ခံရရှိသည် ";

  static String m51(count) =>
      "သင့်ဆန္ဒစာရင်းမှ အရာ ${count} ခုကို ဖယ်ရှားလိုပါသလား။";

  static String m52(percent) => "${percent}% လျှော့စျေး";

  static String m53(keyword) => "ရှာဖွေမှုရလဒ်များ- \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";

  static String m55(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";

  static String m56(second) => "${second} စက္ကန့်အကြာ";

  static String m57(totalCartQuantity) =>
      "စျေးခြင်း၊ ပစ္စည်း ${totalCartQuantity} ခု";

  static String m58(numberOfUnitsSold) => "ရောင်းသည်- ${numberOfUnitsSold}";

  static String m59(price) => "စျေးနှုန်း ${price} မှ စတင်သည်";

  static String m60(fieldName) => " ${fieldName} အကွက် လိုအပ်သည်။";

  static String m61(total) => " ထုတ်ကုန်${total} ခု";

  static String m62(name) => " ${name}သို့ ငွေလွှဲပါ ";

  static String m63(price) => "အမြင့်ဆုံး ${price} ထိ";

  static String m64(amount) => "အမှတ် ${amount} ကို သုံးပါ။";

  static String m65(maxPointDiscount, maxPriceDiscount) =>
      "ဤအမှာစာအတွက် ${maxPriceDiscount} လျှော့စျေးအတွက် အများဆုံး ${maxPointDiscount} မှတ်များကို သုံးပါ။";

  static String m66(time) => "အကျုံးဝင်သည်- ${time}";

  static String m67(date) => " ${date}အထိ အကျုံးဝင်သည် ";

  static String m68(number) => "ဗားရှင်း ${number}";

  static String m69(balance) => "ပိုက်ဆံအိတ်လက်ကျန်- ${balance}";

  static String m70(message) => "သတိပေးချက်: ${message}";

  static String m71(defaultCurrency) =>
      "The currently selected currency is not available for the Wallet feature, please change it to ${defaultCurrency}";

  static String m72(length) => "ပစ္စည်း ${length} ခုတွေ့ရှိပါသည်";

  static String m73(week) => "အပတ် ${week}";

  static String m74(name) => "ကြိုဆိုပါတယ် ${name}";

  static String m75(year) => "${year} နှစ်အကြာက";

  static String m76(count) => "သင်သည် အရာ ${count} ခုကို ရွေးနေသည်";

  static String m77(total) => "You have assigned to order #${total}";

  static String m78(type) => "သင် ${type}ကျော်သွားပါပြီ ";

  static String m79(point) => "သင့်တွင် ပွိုင့် ${point} ရှိပါသည်";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "စကားဝှက်ကို အကြာကြီးပြောင်းလဲခြင်းသည် သင့်အကောင့်ကို ကာကွယ်ပေးနိုင်ပါတယ်",
    ),
    ...
    "addressAddedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "လိပ်စာကို အောင်မြင်စွာ ထည့်ပြီးပါပြီ",
    ),
    "addressManagement": MessageLookupByLibrary.simpleMessage(
      "လိပ်စာစီမံခန့်ခွဲမှု",
    ),
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "ပို့ဆောင်ရန်လိပ်စာ အသစ်ထည့်၊ ပြင်ဆင်ရန်",
    ),
    "addressNotFound": MessageLookupByLibrary.simpleMessage("လိပ်စာမတွေ့ပါ"),
    "addressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "လိပ်စာကို အောင်မြင်စွာ ပြင်ဆင်ပြီးပါပြီ",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "ဤစကားပြောခြင်းကို ပြီးဆုံးချင်ပါသလား?",
    ),
    ...
    "available": MessageLookupByLibrary.simpleMessage("ရရှိနိုင်သည်"),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage(
      "အမှတ်တံဆိပ်များအတွက်လျော့စျေး",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "စကားဝှက်ကိုပြောင်းလဲလို့မရပါ။ ထပ်မံကြိုးစားပါ။",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Razorpay အတွက် ငွေပေးချေမှုဘောင်ချာ မဖန်တီးနိုင်ပါ",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Razorpay အတွက် အော်ဒါ မဖန်တီးနိုင်ပါ",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "လုံခြုံရေး စကားဝှက် ပြင်ဆင်ရန်",
    ),
    "changePasswordSuccess": MessageLookupByLibrary.simpleMessage(
      "စကားဝှက်ကိုအောင်မြင်စွာ ပြောင်းလဲပြီးပါပြီ",
    ),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("နိုင်ငံများ"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("မူလလိပ်စာ"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "မူလလိပ်စာကိုအောင်မြင်စွာပြင်ဆင်ပြီးပါပြီ",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("မူလ"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "ပြသမည့်အမည်ကို နာမည်နှင့်အမျိုးအမည်မှ အလိုအလျောက်ဖန်တီးပါသည်",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("လိပ်စာပြင်ဆင်ရန်"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage(
      "စကားပြောခြင်းကို ပြီးဆုံးရန်",
    ),
    ...
    "enterYourName": MessageLookupByLibrary.simpleMessage("သင့်အမည်ထည့်ပါ"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("အမှား"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "မူလလိပ်စာပြင်ဆင်မှုမအောင်မြင်ပါ",
    ),
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "မေးခွန်းရှိပါသလား? ကျွန်ုပ်တို့ထံ စာရေးပေးပါ!",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "ဝမ်းနည်းပါတယ်! ဒီလင့်ခ်ကို ဖွင့်လို့မရပါ။",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("လိုအပ်သည်"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("တိုက်ရိုက်စကားပြော"),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("အမည်လိုအပ်ပါသည်"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("စကားဝှက်အသစ်"),
    ...
    "noAddressesFound": MessageLookupByLibrary.simpleMessage("လိပ်စာမတွေ့ပါ"),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("ပြသမည့်အမည်မရှိပါ"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ အင်တာနက် မရှိပါ။ ဆက်လက်စျေးဝယ်ရန် ပြန်ချိတ်ဆက်ပါ။",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "ဤအော်ဒါတွင် ထုတ်ကုန်များ မတွေ့ပါ",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "သင် ဝင်ရောက်မလုပ်ရသေးပါ၊ ထွက်ပါက စကားပြောခြင်း သက်တမ်းကုန်သွားပါမည်။",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "မူရင်းလိပ်စာကို မတွေ့ပါ",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("အခြားလိပ်စာ"),
    ...
    "passwordMustBeAtLeast8Characters": MessageLookupByLibrary.simpleMessage(
      "စကားဝှက်သည် အနည်းဆုံး အက္ခရာ ၈ လုံးရှိရပါမည်",
    ),
    "passwordTips": MessageLookupByLibrary.simpleMessage(
      "စကားဝှက် အသုံးပြုရန်အကြံပြုချက်များ:",
    ),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "သင့်ပို့ဆောင်မည့်နိုင်ငံရွေးချယ်ပါ။",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "ထပ်မံမှာယူရန် ထုတ်ကုန် မပြင်ဆင်ရသေးပါ",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "ထုတ်ကုန်အမျိုးအစားများ မရနိုင်ပါ",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("ဒေသများ"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("သက်ဆိုင်မှု"),
    ...
    "removeWishlistContent": m51,
    "rental": MessageLookupByLibrary.simpleMessage("ငှားရမ်းမှု"),
    "rentalDates": MessageLookupByLibrary.simpleMessage("ငှားရမ်းရက်များ"),
    ...
    "searchResultFor": m53,
    "searchResultItem": m54,
    "searchResultItems": m55,
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "WhatsApp ဖြင့် အော်ဒါပေးပို့ရန်",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "သင့်အော်ဒါကို စနစ်ထဲတွင် လက်ခံပြီး၊ ထပ်မံပြီး WhatsApp ဖြင့်ပေးပို့နိုင်ပါသည်။",
    ),
    ...
    "setAsDefault": MessageLookupByLibrary.simpleMessage("မူလအဖြစ်သတ်မှတ်ပါ"),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopify အဖွဲ့ဝင်"),
    "shoppingCartItems": m57,
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• နံပါတ်နှင့် အထူးအက္ခရာများပါဝင်သင့်သည်",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• အကြီးအသေး စာလုံးပါဝင်သင့်သည်",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("စတင်စကားပြောရန်"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("အကြံပြုချက်များ၊"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage(
      "ထိပ်တန်းအမှတ်တံဆိပ်များ",
    ),
    ...
    "types": MessageLookupByLibrary.simpleMessage("အမျိုးအစားများ"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("သတ်မှတ်မထား"),
    ...
    "unknown": MessageLookupByLibrary.simpleMessage("မသိပါ"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("လိပ်စာပြင်ဆင်ပါ"),
    ...
    "updateInformation": MessageLookupByLibrary.simpleMessage(
      "အချက်အလက်ကို ပြင်ဆင်မည်",
    ),
    "updateInformationSuccess": MessageLookupByLibrary.simpleMessage(
      "အချက်အလက်ကို အောင်မြင်စွာ ပြင်ဆင်ပြီးပါပြီ",
    ),
    ...
    "updateYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "သင့်လိပ်စာအချက်အလက်ကိုပြင်ဆင်ပါ",
    ),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("အတည်ပြုမှုအမှား"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• ပြည်နယ်အတွက် ၂-အက္ခရာကုဒ် (CA, NY, TX) ကို အသုံးပြုပါ\n• နိုင်ငံအတွက် ၂-အက္ခရာကုဒ် (US, CA, GB) ကို အသုံးပြုပါ\n• ZIP/စာတိုက်ကုဒ် ဖော်ပြချက်ကို စစ်ဆေးပါ\n• လိုအပ်သောအကွက်အားလုံး ဖြည့်ထားကြောင်း သေချာပါစေ",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "လိပ်စာများကိုကြည့်ရန် သင့်အကောင့်ဖြင့်ဝင်ရောက်ရန်လိုအပ်ပါသည်",
    ),
