...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "A(z) ${currency} pénznemet a Razorpay fiókod nem támogatja. Kérjük, vedd fel a kapcsolatot az ügyfélszolgálattal a nemzetközi fizetések engedélyezéséhez, vagy válts egy támogatott pénznemre.";

  static String m20(day) => "${day} napja";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Hátralévő idő: ${timeLeft}";

  static String m23(captcha) => "A megerősítéshez írja be ezt: ${captcha}";

  static String m24(message) => "Hiba: ${message}";

  static String m25(message) => "Hiba: ${message}";

  static String m26(error) => "Hiba történt: ${error}";

  static String m27(error) => "Hiba történt: ${error}";

  static String m28(time) => "Lejárat ideje: ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} órája";
  ...
  static String m34(size) => "Maximális fájlméret: ${size} MB";
  ...
  static String m37(count) => "Legalább ${count} karakter szükséges";
  ...
  static String m40(value) => "Minimális tranzakció: ${value}";

  static String m41(minute) => "${minute} perce";

  static String m42(month) => "${month} hónappal ezelőtt";

  static String m43(store) => "További termékek innen: ${store}";

  static String m44(number) => "${number} darabos csomagban vásárolható";

  static String m45(itemCount) => "${itemCount} termék";

  static String m46(price) => "Opciók összesen: ${price}";

  static String m47(amount) => "Fizetés: ${amount}";

  static String m48(name) => "A(z) ${name} sikeresen a kosárba került";

  static String m49(total) => "Mennyiség: ${total}";

  static String m50(name) => "Pénz érkezett tőle: ${name}";

  static String m51(count) =>
      "Eltávolít ${count} terméket a kívánságlistájáról?";

  static String m52(percent) => "${percent}% kedvezmény";

  static String m53(keyword) => "Keresési eredmények erre: \"${keyword}\"";

  static String m54(keyword, count) => "${keyword} (${count} találat)";

  static String m55(keyword, count) => "${keyword} (${count} találat)";

  static String m56(second) => "${second} másodperce";

  static String m57(totalCartQuantity) => "Kosár, ${totalCartQuantity} termék";

  static String m58(numberOfUnitsSold) => "Eladva: ${numberOfUnitsSold}";

  static String m59(price) => "Kezdőár: ${price}";

  static String m60(fieldName) => "A(z) ${fieldName} mező kötelező";

  static String m61(total) => "${total} termék";

  static String m62(name) => "Pénz küldése neki: ${name}";

  static String m63(price) => "Legfeljebb ${price}";

  static String m64(amount) => "Használjon ${amount} pontot";
  ...
  static String m66(time) => "Érvényes eddig: ${time}";

  static String m67(date) => "Érvényes: ${date}";

  static String m68(number) => "Verzió: ${number}";

  static String m69(balance) => "Egyenleg: ${balance}";

  static String m70(message) => "Figyelmeztetés: ${message}";
  ...
  static String m72(length) => "Találtunk ${length} terméket";

  static String m73(week) => "${week}. hét";

  static String m74(name) => "Üdvözöljük, ${name}!";

  static String m75(year) => "${year} évvel ezelőtt";

  static String m76(count) => "${count} terméket választott ki";

  static String m77(total) => "A(z) ${total} számú rendelést kapta";

  static String m78(type) => "Lejárt ${type}";

  static String m79(point) => "Jelenleg ${point} pontja van";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Fiókbiztonság"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "A jelszó rendszeres cseréje segít megvédeni a fiókodat",
    ),
    ...
    "addedToCart": MessageLookupByLibrary.simpleMessage("Kosárba helyezve"),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Biztosan be akarod fejezni ezt a csevegést?",
    ),
    ...
    "available": MessageLookupByLibrary.simpleMessage("Elérhető"),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Márkák olcsóbban"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Nem sikerült megváltoztatni a jelszót. Kérjük, próbálja újra.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Nem lehet számlát létrehozni a Razorpay számára",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Nem lehet rendelést létrehozni Razorpay számára",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "A csevegés befejeződött. Kérjük, indíts új csevegést.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Csevegőlista"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Csevegés most"),
    ...
    "confirmPasswordDoesNotMatch": MessageLookupByLibrary.simpleMessage(
      "A megerősített jelszó nem egyezik",
    ),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("országok"),
    ...
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Az alapértelmezett cím sikeresen frissítve",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Alapértelmezett"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "A megjelenített név automatikusan az utónévből és vezetéknévből jön létre",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Cím szerkesztése"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Csevegés befejezése"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Hiba"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Nem sikerült frissíteni az alapértelmezett címet",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Hoppá! Nem sikerült megnyitni ezt a linket.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("kötelező"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Élő csevegés"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Új jelszó"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Nincs internetkapcsolat. Csatlakozzon újra a vásárlás folytatásához.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Nem található termék ebben a rendelésben",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Nincs elérhető üzletinformáció",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Nem vagy bejelentkezve, a csevegés lejár, ha kilépsz.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Eredeti cím nem található",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Egyéb cím"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Jelszó tippek:"),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "Válaszd ki a szállítási célállomást.",
    ),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Kérjük, először adj hozzá egy címet",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Kérjük, engedélyezze a helyhozzáférést",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Kérjük, ellenőrizze a következő problémákat:",
    ),
    ...
    "pleaseEnterNewPassword": MessageLookupByLibrary.simpleMessage(
      "Kérjük, add meg az új jelszavadat",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "A termék nem áll készen újrarendelésre",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Termékváltozatok nem érhetők el",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Régiók"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Relevancia"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Bérlés dátumai"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Mentett címek"),
    "savedToGallery": MessageLookupByLibrary.simpleMessage("Galériába mentve"),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Rendelés küldése WhatsApp-on",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "A rendelése bekerült a rendszerbe, és ugyanazt a rendelést elküldheti WhatsApp-on is.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopify tag"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Tartalmazzon számokat és speciális karaktereket",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Csevegés indítása"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Tippek:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Top márkák"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Típusok"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Nem meghatározott"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Cím frissítése"),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Használjon 2 karakteres államkódokat (CA, NY, TX)\n• Használjon 2 karakteres országkódokat (US, CA, GB)\n• Ellenőrizze az irányítószám/formátumot\n• Győződjön meg róla, hogy minden kötelező mező ki van töltve",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Be kell jelentkezned, hogy láthasd a címeket",
    ),
