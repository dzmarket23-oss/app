...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(day) => "${day} 天前";

  static String m21(total) => "约${total}公里";

  static String m22(timeLeft) => "剩余 ${timeLeft}";

  static String m23(captcha) => "输入${captcha}进行确认：";

  static String m24(message) => "错误：${message}";

  static String m25(message) => "错误：${message}";

  static String m26(error) => "发生错误：${error}";

  static String m27(error) => "发生错误：${error}";

  static String m28(time) => "${time} 后过期";

  static String m29(total) => "大于${total}公里";

  static String m30(hour) => "${hour} 小时前";

  static String m31(currentBalance) => "您的钱包余额仅剩${currentBalance}";

  static String m32(message) => "应用程序在请求数据时出现问题，请联系管理员解决：${message}";

  static String m33(currency, amount) => "使用此支付方式的最大金额为${currency} ${amount}";

  static String m34(size) => "最大文件大小：${size} MB";

  static String m35(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m36(currency, amount) => "使用此支付方式的最小金额为${currency} ${amount}";

  static String m37(count) => "至少需要 ${count} 个字符";

  static String m38(storeName, minOrderAmount) =>
      " ${storeName} 的最低订购金额为 ${minOrderAmount}。请从该商店添加更多商品！";

  static String m39(amount) => "此优惠券要求最低购买金额为 ${amount}。";

  static String m40(value) => "最低交易次数： ${value}";

  static String m41(minute) => "${minute} 分钟前";

  static String m42(month) => "${month} 个月前";

  static String m43(store) => "${store}的更多商品";

  static String m44(number) => "必须按${number}件为单位购买";

  static String m45(itemCount) => "${itemCount} 件商品";

  static String m46(price) => "选项总计：${price}";

  static String m47(amount) => "支付${amount}";

  static String m48(name) => "已将${name}添加到购物车";

  static String m49(total) => "数量：${total}";

  static String m50(name) => "已收到来自${name}的款项";

  static String m51(count) => "是否要从心愿单中移除${count}件商品？";

  static String m52(percent) => "优惠 ${percent}%";

  static String m53(keyword) => "\"${keyword}\"的搜索结果";

  static String m54(keyword, count) => "${keyword}（${count}项）";

  static String m55(keyword, count) => "${keyword}（${count}项）";

  static String m56(second) => "${second} 秒前";

  static String m57(totalCartQuantity) => "购物车，${totalCartQuantity} 件商品";

  static String m58(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m59(price) => "起价 ${price}";

  static String m60(fieldName) => "${fieldName}为必填项";

  static String m61(total) => "${total} 个商品";

  static String m62(name) => "转账给${name}";

  static String m63(price) => "最高 ${price}";

  static String m64(amount) => "使用 ${amount} 积分";

  static String m65(maxPointDiscount, maxPriceDiscount) =>
      "使用${maxPointDiscount}积分可获得此订单${maxPriceDiscount}的折扣！";

  static String m66(time) => "有效期至: ${time}";

  static String m67(date) => "有效期至 ${date}";

  static String m68(number) => "版本 ${number}";

  static String m69(balance) => "钱包余额：${balance}";

  static String m70(message) => "警告：${message}";

  static String m71(defaultCurrency) => "当前选择的货币不支持钱包功能，请改为${defaultCurrency}";

  static String m72(length) => "找到 ${length} 个商品";

  static String m73(week) => "第 ${week} 周";

  static String m74(name) => "欢迎，${name}";

  static String m75(year) => "${year}年前";

  static String m76(count) => "您已选择${count}个商品";

  static String m77(total) => "您已被分配订单#${total}";

  static String m78(type) => "您已通过 ${type}";

  static String m79(point) => "您有 ${point} 积分";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("品牌特卖"),
