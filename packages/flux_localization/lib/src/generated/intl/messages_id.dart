...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Mata uang ${currency} tidak didukung oleh akun Razorpay Anda. Silakan hubungi dukungan untuk mengaktifkan pembayaran internasional atau ubah ke mata uang yang didukung.";
  ...
  static String m23(captcha) => "Masukkan ${captcha} untuk mengonfirmasi:";

  static String m24(message) => "Error: ${message}";

  static String m25(message) => "Kesalahan: ${message}";

  static String m26(error) => "Terjadi kesalahan: ${error}";

  static String m27(error) => "Terjadi kesalahan: ${error}";

  static String m28(time) => "Berakhir dalam ${time}";
  ...
  static String m34(size) => "Ukuran file maksimum: ${size} MB";
  ...
  static String m37(count) => "Minimal ${count} karakter diperlukan";
  ...
  static String m41(minute) => "${minute} menit yang lalu";

  static String m42(month) => "${month} bulan yang lalu";

  static String m43(store) => "Lainnya dari ${store}";

  static String m44(number) => "Harus dibeli dalam kelompok ${number}";

  static String m45(itemCount) => "${itemCount} item";

  static String m46(price) => "Total opsi: ${price}";

  static String m47(amount) => "Bayar ${amount}";

  static String m48(name) => "${name} berhasil ditambahkan ke keranjang";

  static String m49(total) => "Jumlah: ${total}";

  static String m50(name) => "Menerima uang dari ${name}";

  static String m51(count) =>
      "Apakah Anda ingin menghapus ${count} item dari daftar keinginan?";

  static String m52(percent) => "Diskon ${percent}%";

  static String m53(keyword) => "Hasil pencarian untuk: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} barang)";

  static String m55(keyword, count) => "${keyword} (${count} barang)";

  static String m56(second) => "${second} detik yang lalu";
  ...
  static String m59(price) => "Mulai dari ${price}";

  static String m60(fieldName) => "Bidang ${fieldName} wajib diisi";

  static String m61(total) => "${total} produk";

  static String m62(name) => "Transfer uang ke ${name}";

  static String m63(price) => "Hingga ${price}";

  static String m64(amount) => "Gunakan ${amount} poin";
  ...
  static String m66(time) => "Berlaku sampai: ${time}";

  static String m67(date) => "Berlaku hingga ${date}";

  static String m68(number) => "Versi ${number}";

  static String m69(balance) => "Saldo dompet: ${balance}";

  static String m70(message) => "Peringatan: ${message}";
  ...
  static String m72(length) => "Kami menemukan ${length} produk";
  ...
  static String m76(count) => "Anda memilih ${count} item";

  static String m77(total) => "Anda telah ditugaskan untuk pesanan #${total}";

  static String m78(type) => "Anda telah melewati ${type}";

  static String m79(point) => "Anda memiliki ${point} poin";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Keamanan Akun"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Mengganti kata sandi secara berkala membantu melindungi akun Anda",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Tidak dapat mengubah kata sandi. Silakan coba lagi.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Tidak dapat membuat faktur untuk Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Tidak dapat membuat pesanan untuk Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Chat telah diakhiri. Silakan mulai chat baru.",
    ),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Alamat Default"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Alamat default berhasil diperbarui",
    ),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Nama tampilan dibuat otomatis dari nama depan dan nama belakang",
    ),
    "distance": m21,
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Akhiri Chat"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Kesalahan"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Gagal memperbarui alamat default",
    ),
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Punya pertanyaan? Tulis kepada kami!",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ups! Kami tidak dapat membuka tautan ini.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("wajib diisi"),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("Nama wajib diisi"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Tidak ada internet. Sambungkan kembali untuk melanjutkan belanja.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Tidak ada produk ditemukan dalam pesanan ini",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Anda belum masuk, chat akan berakhir jika Anda keluar.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Alamat asli tidak ditemukan",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Alamat Lainnya"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Tips kata sandi:"),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produk belum siap untuk dipesan ulang",
    ),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Relevansi"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Tanggal sewa"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Pesanan Anda telah diterima di sistem dan Anda dapat mengirim pesanan yang sama melalui WhatsApp.",
    ),
    ...
    "setAsDefault": MessageLookupByLibrary.simpleMessage("Jadikan Default"),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Anggota Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Harus mengandung angka dan karakter khusus",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Mulai Chat"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Perbarui Alamat"),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Gunakan kode negara bagian 2 huruf (CA, NY, TX)\n• Gunakan kode negara 2 huruf (US, CA, GB)\n• Periksa format kode pos/ZIP\n• Pastikan semua kolom wajib terisi",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Anda perlu login untuk melihat alamat",
    ),
