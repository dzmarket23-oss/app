...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Valuta ${currency} nije podržana na vašem Razorpay računu. Molimo kontaktirajte podršku da omogućite međunarodna plaćanja ili promijenite na podržanu valutu.";

  static String m20(day) => "prije ${day} dana";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Završava za ${timeLeft}";

  static String m23(captcha) => "Unesite ${captcha} za potvrdu:";

  static String m24(message) => "Greška: ${message}";

  static String m25(message) => "Greška: ${message}";

  static String m26(error) => "Došlo je do greške: ${error}";

  static String m27(error) => "Došlo je do greške: ${error}";

  static String m28(time) => "Ističe za ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "prije ${hour} sati";
  ...
  static String m34(size) => "Maksimalna veličina datoteke: ${size} MB";
  ...
  static String m37(count) => "Potrebno je najmanje ${count} znakova";
  ...
  static String m40(value) => "Minimalna transakcija: ${value}";

  static String m41(minute) => "prije ${minute} minuta";

  static String m42(month) => "prije ${month} mjeseci";

  static String m43(store) => "Više od ${store}";

  static String m44(number) => "mora se kupiti u grupama od ${number}";

  static String m45(itemCount) => "${itemCount} artikala";

  static String m46(price) => "Ukupno opcija: ${price}";

  static String m47(amount) => "Plati ${amount}";

  static String m48(name) => "${name} su uspješno dodani u korpu";

  static String m49(total) => "Količina: ${total}";

  static String m50(name) => "Primljen novac od ${name}";

  static String m51(count) =>
      "Želite li ukloniti sljedeći broj stavki: ${count} sa svoje liste želja?";

  static String m52(percent) => "Sniženje ${percent}%";

  static String m53(keyword) => "Rezultati pretrage za: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} stavka)";

  static String m55(keyword, count) => "${keyword} (${count} stavki)";

  static String m56(second) => "prije ${second} sekundi";

  static String m57(totalCartQuantity) =>
      "Korpa, ${totalCartQuantity} artikala";

  static String m58(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m59(price) => "Počinje od ${price}";

  static String m60(fieldName) => "Polje ${fieldName} je obavezno";

  static String m61(total) => "${total} proizvoda";

  static String m62(name) => "Prenesite novac na ${name}";

  static String m63(price) => "Do ${price}";

  static String m64(amount) => "Iskoristite ${amount} poena";
  ...
  static String m66(time) => "Vrijedi do: ${time}";

  static String m67(date) => "Važi do ${date}";

  static String m68(number) => "Verzija ${number}";

  static String m69(balance) => "Stanje novčanika: ${balance}";

  static String m70(message) => "Upozorenje: ${message}";
  ...
  static String m72(length) => "Pronašli smo ${length} proizvoda";

  static String m73(week) => "Sedmica ${week}";

  static String m74(name) => "Dobro došli ${name}";

  static String m75(year) => "prije ${year} godina";

  static String m76(count) => "Odabirete sljedeći broj stavki: ${count} ";

  static String m77(total) => "Dodijeljeni ste narudžbi #${total}";

  static String m78(type) => "Prošli ste ${type}";

  static String m79(point) => "Imate ${point} bodova";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Sigurnost računa"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Redovno mijenjanje lozinke pomaže u zaštiti vašeg računa",
    ),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Dodajte, uredite adrese za dostavu",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Jeste li sigurni da želite završiti ovaj chat?",
    ),
    ...
    "available": MessageLookupByLibrary.simpleMessage("Dostupno"),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Brendovi Za Manje"),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Ne možete kreirati fakturu za Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Ne možete kreirati narudžbu za Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Chat je završen. Molimo započnite novi chat.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Poruke"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Čavrljaj sada"),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("zemlje"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage(
      "Podrazumijevana adresa",
    ),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Podrazumijevana adresa je uspješno ažurirana",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Podrazumijevano"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Prikazano ime se automatski generiše iz imena i prezimena",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Uredi adresu"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Završi chat"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Greška"),
    ...
    "failedToSaveImage": MessageLookupByLibrary.simpleMessage(
      "Nije uspjelo sačuvati sliku",
    ),
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Neuspješno ažuriranje podrazumijevane adrese",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ups! Nismo mogli otvoriti ovu poveznicu.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("je obavezno"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Chat uživo"),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("Ime je obavezno"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Nova lozinka"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Nema interneta. Ponovo se povežite za nastavak kupovine.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Nema proizvoda u ovoj narudžbi",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Nema dostupnih informacija o prodavnici",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Niste prijavljeni, chat će isteći ako izađete.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Originalna adresa nije pronađena",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Druga adresa"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Savjeti za lozinku:"),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "Odaberite svoju destinaciju za dostavu.",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Molimo omogućite pristup lokaciji",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Molimo provjerite sljedeće probleme:",
    ),
    ...
    "pleaseConfirmNewPassword": MessageLookupByLibrary.simpleMessage(
      "Molimo potvrdite svoju novu lozinku",
    ),
    "pleaseEnterCurrentPassword": MessageLookupByLibrary.simpleMessage(
      "Molimo unesite svoju trenutnu lozinku",
    ),
    "pleaseEnterFirstName": MessageLookupByLibrary.simpleMessage("Unesite ime"),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Proizvod nije spreman za ponovnu narudžbu",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Varijacije proizvoda nisu dostupne",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Regije"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Datumi najma"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Sačuvane adrese"),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Pošaljite narudžbu putem WhatsApp-a",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Vaša narudžba je primljena u sistem i možete poslati istu narudžbu putem WhatsApp-a.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopify član"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Treba sadržavati brojeve i posebne znakove",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• Treba sadržavati velika i mala slova",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Započni chat"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Savjeti:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Najbolji brendovi"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Tipovi"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Nedefinisano"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Ažuriraj adresu"),
    ...
    "updateInformationSuccess": MessageLookupByLibrary.simpleMessage(
      "Informacije su uspješno ažurirane",
    ),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Koristite dvoslovne kodove država (CA, NY, TX)\n• Koristite dvoslovne kodove zemalja (US, CA, GB)\n• Provjerite format poštanskog broja\n• Osigurajte da su sva obavezna polja popunjena",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Morate se prijaviti da biste vidjeli adrese",
    ),
