...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(day) => "acum ${day} zile";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Se termină în ${timeLeft}";

  static String m23(captcha) => "Introdu ${captcha} pentru a confirma:";

  static String m24(message) => "Eroare: ${message}";

  static String m25(message) => "Eroare: ${message}";

  static String m26(error) => "A apărut o eroare: ${error}";

  static String m27(error) => "A apărut o eroare: ${error}";

  static String m28(time) => "Expiră în ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "acum ${hour} ore";
  ...
  static String m34(size) => "Dimensiune maximă fișier: ${size} MB";
  ...
  static String m37(count) => "Sunt necesare minimum ${count} caractere";
  ...
  static String m40(value) => "Tranzacție minimă: ${value}";

  static String m41(minute) => "acum ${minute} minute";

  static String m42(month) => "acum ${month} luni";

  static String m43(store) => "Mai multe de la ${store}";

  static String m44(number) => "Trebuie cumpărat în grupuri de ${number}";

  static String m45(itemCount) => "${itemCount} articole";

  static String m46(price) => "Total opțiuni: ${price}";

  static String m47(amount) => "Plătește ${amount}";

  static String m48(name) => "${name} a fost adăugat în coș cu succes";

  static String m49(total) => "Cantitate: ${total}";

  static String m50(name) => "A primit bani de la ${name}";

  static String m51(count) =>
      "Vrei să elimini ${count} produs(e) din lista ta de dorințe?";

  static String m52(percent) => "Reducere ${percent}%";

  static String m53(keyword) => "Rezultatele căutării pentru: „${keyword}";

  static String m54(keyword, count) => "${keyword} (${count} articol)";

  static String m55(keyword, count) => "${keyword} (${count} articole)";

  static String m56(second) => "acum ${second} secunde";

  static String m57(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m58(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m59(price) => "Începând de la ${price}";

  static String m60(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m61(total) => "${total} produse";

  static String m62(name) => "Transferă bani către ${name}";

  static String m63(price) => "Până la ${price}";

  static String m64(amount) => "Folosiți ${amount} puncte";
  ...
  static String m66(time) => "Valabil până la: ${time}";

  static String m67(date) => "Valabil până la ${date}";

  static String m68(number) => "Versiunea ${number}";

  static String m69(balance) => "Sold portofel: ${balance}";

  static String m70(message) => "Atenție: ${message}";
  ...
  static String m72(length) => "Am găsit ${length} produse";

  static String m73(week) => "Săptămâna ${week}";

  static String m74(name) => "Bun venit, ${name}";

  static String m75(year) => "acum ${year} ani";

  static String m76(count) => "Selectezi ${count} produs(e)";

  static String m77(total) => "Ai fost atribuit comenzii #${total}";

  static String m78(type) => "Ai trecut de ${type}";

  static String m79(point) => "Ai ${point} puncte";
