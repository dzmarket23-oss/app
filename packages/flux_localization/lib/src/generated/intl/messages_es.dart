...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "La moneda ${currency} no es compatible con tu cuenta de Razorpay. Por favor, contacta con soporte para habilitar pagos internacionales o cambia a una moneda compatible.";

  static String m20(day) => "Hace ${day} días";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Termina en ${timeLeft}";

  static String m23(captcha) => "Ingresa ${captcha} para confirmar:";

  static String m24(message) => "Error: ${message}";

  static String m25(message) => "Error: ${message}";

  static String m26(error) => "Ocurrió un error: ${error}";

  static String m27(error) => "Ocurrió un error: ${error}";

  static String m28(time) => "Expira en ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "Hace ${hour} horas";
  ...
  static String m34(size) => "Tamaño máximo del archivo: ${size} MB";
  ...
  static String m37(count) => "Se requieren al menos ${count} caracteres";
  ...
  static String m40(value) => "Transacción mínima: ${value}";

  static String m41(minute) => "Hace ${minute} minutos";

  static String m42(month) => "Hace ${month} meses";

  static String m43(store) => "Más de ${store}";

  static String m44(number) => "Debe comprarse en grupos de ${number}";

  static String m45(itemCount) => "${itemCount} artículos";

  static String m46(price) => "Total de opciones: ${price}";

  static String m47(amount) => "Pagar ${amount}";

  static String m48(name) => "${name} agregado al carrito";

  static String m49(total) => "Cantidad: ${total}";

  static String m50(name) => "Recibiste dinero de ${name}";

  static String m51(count) =>
      "¿Quieres eliminar ${count} artículo(s) de tu lista de deseos?";

  static String m52(percent) => "Descuento ${percent}%";

  static String m53(keyword) => "Resultados de búsqueda para: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} elemento)";

  static String m55(keyword, count) => "${keyword} (${count} elementos)";

  static String m56(second) => "Hace ${second} segundos";
  ...
  static String m59(price) => "Desde ${price}";

  static String m60(fieldName) => "El campo ${fieldName} es obligatorio";

  static String m61(total) => "${total} productos";

  static String m62(name) => "Transferir dinero a ${name}";

  static String m63(price) => "Hasta ${price}";

  static String m64(amount) => "Utiliza ${amount} puntos";
  ...
  static String m66(time) => "Válido hasta: ${time}";

  static String m67(date) => "Válido hasta ${date}";

  static String m68(number) => "Versión ${number}";

  static String m69(balance) => "Saldo de la billetera: ${balance}";

  static String m70(message) => "Advertencia: ${message}";
  ...
  static String m72(length) => "Encontramos ${length} productos";

  static String m73(week) => "Semana ${week}";

  static String m74(name) => "Bienvenido ${name}";

  static String m75(year) => "Hace ${year} años";

  static String m76(count) => "Estás seleccionando ${count} artículo(s)";

  static String m77(total) => "Has sido asignado al pedido #${total}";

  static String m78(type) => "Has superado ${type}";

  static String m79(point) => "Tienes ${point} puntos";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Cambiar tu contraseña regularmente ayuda a proteger tu cuenta",
    ),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Agregar, editar direcciones de envío",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "No se puede cambiar la contraseña. Por favor, inténtalo de nuevo.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "No se puede crear una factura para Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "No se puede crear el pedido para Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "El chat ha finalizado. Por favor, inicia un nuevo chat.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Mensajes"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Chatear ahora"),
    ...
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Predeterminada"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "El nombre para mostrar se genera automáticamente a partir del nombre y apellido",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Editar dirección"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "No se pudo actualizar la dirección predeterminada",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "¡Vaya! No pudimos abrir este enlace.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("es obligatorio"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Chat en vivo"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Sin internet. Reconéctate para seguir comprando.",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "No hay información disponible de la tienda",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "No has iniciado sesión, el chat expirará si sales.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Dirección original no encontrada",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Otra dirección"),
    ...
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Actualizar nombre, número de teléfono",
    ),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Por favor, agrega una dirección primero",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Producto no listo para volver a ordenar",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Variaciones de producto no disponibles",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Regiones"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Fechas de alquiler"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Tu pedido ha sido recibido en el sistema y puedes enviar el mismo pedido por WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Miembro de Shopify"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Marcas principales"),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Necesitas iniciar sesión para ver las direcciones",
    ),
