...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(day) => "${day}日前";

  static String m21(total) => "${total}km";

  static String m22(timeLeft) => "残り${timeLeft}";

  static String m23(captcha) => "${captcha}を入力して確認してください";

  static String m24(message) => "エラー：${message}";

  static String m25(message) => "エラー：${message}";

  static String m26(error) => "エラーが発生しました: ${error}";

  static String m27(error) => "エラーが発生しました: ${error}";

  static String m28(time) => "有効期限：${time}";

  static String m29(total) => "${total}km以上";

  static String m30(hour) => "${hour}時間前";

  static String m31(currentBalance) => "ウォレット残高が不足しています（残高：${currentBalance}）";

  static String m32(message) => "データの取得中に問題が発生しました。管理者に連絡してください：${message}";

  static String m33(currency, amount) => "この支払いの上限額は${currency} ${amount}です";

  static String m34(size) => "最大ファイルサイズ：${size} MB";

  static String m35(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m36(currency, amount) => "この支払いの最低額は${currency} ${amount}です";

  static String m37(count) => "最低${count}文字が必要です";

  static String m38(storeName, minOrderAmount) =>
      " ${storeName} の最低注文金額は ${minOrderAmount}です。このストアからさらに商品を追加してください。";

  static String m39(amount) => "このクーポンは最低 ${amount}の購入が必要です。";

  static String m40(value) => "最小取引: ${value}";

  static String m41(minute) => "${minute}分前";

  static String m42(month) => "${month}ヶ月前";

  static String m43(store) => "${store}の他の商品";

  static String m44(number) => "${number}個単位で購入する必要があります";

  static String m45(itemCount) => "${itemCount}点";

  static String m46(price) => "オプション合計：${price}";

  static String m47(amount) => "${amount}を支払う";

  static String m48(name) => "${name}をカートに追加しました";

  static String m49(total) => "数量：${total}";

  static String m50(name) => "${name}から入金がありました";

  static String m51(count) => "${count}個の商品をお気に入りから削除しますか？";

  static String m52(percent) => "セール ${percent}%オフ";

  static String m53(keyword) => "「${keyword}」の検索結果";

  static String m54(keyword, count) => "${keyword}（${count}件）";

  static String m55(keyword, count) => "${keyword}（${count}件）";

  static String m56(second) => "${second}秒前";

  static String m57(totalCartQuantity) => "カート内の商品：${totalCartQuantity}点";

  static String m58(numberOfUnitsSold) => "売れた数：${numberOfUnitsSold}";

  static String m59(price) => "${price}から開始";

  static String m60(fieldName) => "${fieldName}は必須項目です";

  static String m61(total) => "商品数：${total}";

  static String m62(name) => "${name}に送金";

  static String m63(price) => "最大${price}まで";

  static String m64(amount) => " ${amount} ポイントを使用する";

  static String m65(maxPointDiscount, maxPriceDiscount) =>
      "この注文で最大${maxPointDiscount}ポイントを使用すると、${maxPriceDiscount}の割引が適用されます。";

  static String m66(time) => "有効期限: ${time}";

  static String m67(date) => "${date}まで有効";

  static String m68(number) => "バージョン ${number}";

  static String m69(balance) => "ウォレット残高：${balance}";

  static String m70(message) => "警告：${message}";

  static String m71(defaultCurrency) =>
      "現在選択されている通貨はウォレット機能では利用できません。${defaultCurrency}に変更してください";

  static String m72(length) => "${length}件の商品が見つかりました";

  static String m73(week) => "週 ${week}";

  static String m74(name) => "ようこそ、${name}さん";

  static String m75(year) => "${year}年前";

  static String m76(count) => "${count}個の商品を選択中";

  static String m77(total) => "注文番号${total}に割り当てられました";

  static String m78(type) => " ${type}に合格しました";

  static String m79(point) => "${point}ポイントあります";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("ブランド・フォー・レス"),
