...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Валюта ${currency} не підтримується вашим обліковим записом Razorpay. Зверніться до служби підтримки, щоб увімкнути міжнародні платежі або змініть на підтримувану валюту.";

  static String m20(day) => "${day} днів тому";

  static String m21(total) => "~${total} км";

  static String m22(timeLeft) => "Закінчується через ${timeLeft}";

  static String m23(captcha) => "Введіть ${captcha} для підтвердження:";

  static String m24(message) => "Помилка: ${message}";

  static String m25(message) => "Помилка: ${message}";

  static String m26(error) => "Виникла помилка: ${error}";

  static String m27(error) => "Виникла помилка: ${error}";

  static String m28(time) => "Закінчується через ${time}";

  static String m29(total) => ">${total} км";

  static String m30(hour) => "${hour} годин тому";
  ...
  static String m34(size) => "Максимальний розмір файлу: ${size} МБ";
  ...
  static String m37(count) => "Потрібно щонайменше ${count} символів";
  ...
  static String m40(value) => "Мінімальна транзакція: ${value}";

  static String m41(minute) => "${minute} хвилин тому";

  static String m42(month) => "${month} місяців тому";

  static String m43(store) => "Більше від ${store}";

  static String m44(number) => "Необхідно купувати групами по ${number}";

  static String m45(itemCount) => "${itemCount} товарів";

  static String m46(price) => "Всього опцій: ${price}";

  static String m47(amount) => "Оплатити ${amount}";

  static String m48(name) => "${name} успішно додано до кошика";

  static String m49(total) => "Кількість: ${total}";

  static String m50(name) => "Отримано кошти від ${name}";

  static String m51(count) =>
      "Бажаєте видалити ${count} товарів зі списку бажань?";

  static String m52(percent) => "Знижка ${percent}%";

  static String m53(keyword) => "Результати пошуку для: \"${keyword}\"";

  static String m54(keyword, count) => "${keyword} (${count} товар)";

  static String m55(keyword, count) => "${keyword} (${count} товарів)";

  static String m56(second) => "${second} секунд тому";

  static String m57(totalCartQuantity) => "Кошик, ${totalCartQuantity} товарів";

  static String m58(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m59(price) => "Від ${price}";

  static String m60(fieldName) => "Поле ${fieldName} є обов\'язковим";

  static String m61(total) => "${total} товарів";

  static String m62(name) => "Переказати кошти ${name}";

  static String m63(price) => "До ${price}";

  static String m64(amount) => "Використати ${amount} балів";
  ...
  static String m66(time) => "Дійсний до: ${time}";

  static String m67(date) => "Дійсний до ${date}";

  static String m68(number) => "Версія ${number}";

  static String m69(balance) => "Баланс гаманця: ${balance}";

  static String m70(message) => "Попередження: ${message}";
  ...
  static String m72(length) => "Знайдено ${length} товарів";

  static String m73(week) => "Тиждень ${week}";

  static String m74(name) => "Ласкаво просимо, ${name}";

  static String m75(year) => "${year} років тому";

  static String m76(count) => "Ви обираєте ${count} товарів";

  static String m77(total) => "Вам призначено замовлення №${total}";

  static String m78(type) => "Ви пройшли ${type}";

  static String m79(point) => "У вас є ${point} балів";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Безпека акаунта"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Регулярна зміна пароля допомагає захистити ваш акаунт",
    ),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Додавати, редагувати адреси доставки",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Ви впевнені, що хочете завершити цей чат?",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Не вдалося змінити пароль. Будь ласка, спробуйте ще раз.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Не вдалося створити рахунок для Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Не вдалося створити замовлення для Razorpay",
    ),
    ...
    "company": MessageLookupByLibrary.simpleMessage("Компанія"),
    ...
    "confirmPasswordDoesNotMatch": MessageLookupByLibrary.simpleMessage(
      "Підтвердження пароля не співпадає",
    ),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("країни"),
    ...
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Адресу за замовчуванням успішно оновлено",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("За замовчуванням"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Відображуване ім’я автоматично створюється з імені та прізвища",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Редагувати адресу"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Завершити чат"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Введіть інформацію про адресу",
    ),
    "enterYourCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "Введіть ваше поточне місцезнаходження",
    ),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Помилка"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Не вдалося оновити адресу за замовчуванням",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ой! Нам не вдалося відкрити це посилання.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("обов\'язково"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Онлайн-чат"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Новий пароль"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Немає інтернету. Підключіться, щоб продовжити покупки.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "У цьому замовленні не знайдено товарів",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Інформація про магазин відсутня",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Ви не ввійшли в систему, чат буде завершено, якщо ви вийдете.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Оригінальну адресу не знайдено",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Інша адреса"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Поради щодо пароля:"),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, спочатку додайте адресу",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, надайте доступ до місцезнаходження",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, перевірте наступні проблеми:",
    ),
    ...
    "pleaseConfirmNewPassword": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, підтвердьте свій новий пароль",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Товар не готовий до повторного замовлення",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Регіони"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Актуальність"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Дати оренди"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Збережені адреси"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Пошук країн..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Надіслати замовлення через WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Ваше замовлення отримано в системі, і ви можете надіслати це ж замовлення через WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Учасник Shopify"),
    ...
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• Має містити великі та малі літери",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Почати чат"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Топ бренди"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Типи"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Невизначено"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Оновити адресу"),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Використовуйте 2-літерні коди штатів (CA, NY, TX)\n• Використовуйте 2-літерні коди країн (US, CA, GB)\n• Перевірте формат ZIP/поштового коду\n• Переконайтеся, що всі обов\'язкові поля заповнені",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Ви повинні увійти, щоб переглянути адреси",
    ),
