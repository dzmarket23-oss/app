...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m37(count) => "Minimum ${count} characters required";
  ...
  static String m40(value) => "Min transaction: ${value}";

  static String m41(minute) => "${minute} minutes ago";

  static String m42(month) => "${month} months ago";

  static String m43(store) => "More from ${store}";

  static String m44(number) => "Must be bought in groups of ${number}";

  static String m45(itemCount) => "${itemCount} items";

  static String m46(price) => "Options total: ${price}";

  static String m47(amount) => "Pay ${amount}";

  static String m48(name) => "${name} have been added to cart successfully";

  static String m49(total) => "Qty: ${total}";

  static String m50(name) => "Received money from ${name}";

  static String m51(count) =>
      "Do you want to remove ${count} item(s) from your wishlist?";

  static String m52(percent) => "${percent}% Off";

  static String m53(keyword) => "Search results for: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} item)";

  static String m55(keyword, count) => "${keyword} (${count} items)";

  static String m56(second) => "${second} seconds ago";
  ...
  static String m59(price) => "Starts from ${price}";

  static String m60(fieldName) => "The ${fieldName} field is required";

  static String m61(total) => "${total} products";

  static String m62(name) => "Transfer money to ${name}";

  static String m63(price) => "Up to ${price}";

  static String m64(amount) => "Use ${amount} points";
  ...
  static String m66(time) => "Valid until: ${time}";

  static String m67(date) => "Valid until ${date}";

  static String m68(number) => "Version ${number}";

  static String m69(balance) => "Wallet balance: ${balance}";

  static String m70(message) => "Warning: ${message}";
  ...
  static String m72(length) => "We found ${length} products";

  static String m73(week) => "Week ${week}";

  static String m74(name) => "Welcome ${name}";

  static String m75(year) => "${year} years ago";

  static String m76(count) => "You are selecting ${count} item(s)";

  static String m77(total) => "You have been assigned to order #${total}";

  static String m78(type) => "You have passed ${type}";

  static String m79(point) => "You have ${point} points";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Rental dates"),
