...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Valuta ${currency} wordt niet ondersteund door je Razorpay-account. Neem contact op met de ondersteuning om internationale betalingen te activeren of kies een ondersteunde valuta.";

  static String m20(day) => "${day} dagen geleden";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Eindigt over ${timeLeft}";

  static String m23(captcha) => "Voer ${captcha} in om te bevestigen:";

  static String m24(message) => "Fout: ${message}";

  static String m25(message) => "Fout: ${message}";

  static String m26(error) => "Er is een fout opgetreden: ${error}";

  static String m27(error) => "Er is een fout opgetreden: ${error}";

  static String m28(time) => "Verloopt over ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} uur geleden";
  ...
  static String m34(size) => "Maximale bestandsgrootte: ${size} MB";
  ...
  static String m37(count) => "Minimaal ${count} tekens vereist";
  ...
  static String m40(value) => "Minimale transactie: ${value}";

  static String m41(minute) => "${minute} minuten geleden";

  static String m42(month) => "${month} maanden geleden";

  static String m43(store) => "Meer van ${store}";

  static String m44(number) => "Moet worden gekocht in groepen van ${number}";

  static String m45(itemCount) => "${itemCount} items";

  static String m46(price) => "Opties totaal: ${price}";

  static String m47(amount) => "Betaal ${amount}";

  static String m48(name) =>
      "${name} is succesvol aan de winkelwagen toegevoegd";

  static String m49(total) => "Aantal: ${total}";

  static String m50(name) => "Geld ontvangen van ${name}";

  static String m51(count) =>
      "Wilt u ${count} item(s) van uw verlanglijst verwijderen?";

  static String m52(percent) => "Aanbieding ${percent}%";

  static String m53(keyword) => "Zoekresultaten voor: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} artikel)";

  static String m55(keyword, count) => "${keyword} (${count} artikelen)";

  static String m56(second) => "${second} seconden geleden";

  static String m57(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} items";

  static String m58(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m59(price) => "Vanaf ${price}";

  static String m60(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m61(total) => "${total} producten";

  static String m62(name) => "Geld overmaken naar ${name}";

  static String m63(price) => "Tot ${price}";

  static String m64(amount) => "Gebruik ${amount} punten";
  ...
  static String m66(time) => "Geldig tot: ${time}";

  static String m67(date) => "Geldig tot ${date}";

  static String m68(number) => "Versie ${number}";

  static String m69(balance) => "Saldo portemonnee: ${balance}";

  static String m70(message) => "Waarschuwing: ${message}";
  ...
  static String m72(length) => "We hebben ${length} producten gevonden";

  static String m73(week) => "Week ${week}";

  static String m74(name) => "Welkom ${name}";

  static String m75(year) => "${year} jaar geleden";

  static String m76(count) => "U selecteert ${count} item(s)";

  static String m77(total) => "U bent toegewezen aan bestelling #${total}";

  static String m78(type) => "Je bent geslaagd voor ${type}";

  static String m79(point) => "Je hebt ${point} punten";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Je wachtwoord regelmatig wijzigen helpt je account te beschermen",
    ),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Merken Voor Minder"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Kan wachtwoord niet wijzigen. Probeer het opnieuw.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Kan geen factuur aanmaken voor Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Kan geen bestelling aanmaken voor Razorpay",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Beveiligingswachtwoord bijwerken",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "De chat is beëindigd. Start een nieuwe chat.",
    ),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("landen"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Standaardadres"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Standaardadres succesvol bijgewerkt",
    ),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Weergavenaam wordt automatisch gegenereerd uit voor- en achternaam",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Adres bewerken"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Chat beëindigen"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Fout"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Standaardadres bijwerken mislukt",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Oeps! We konden deze link niet openen.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("is vereist"),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("Naam is verplicht"),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("Geen weergavenaam"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Geen internet. Verbind opnieuw om verder te winkelen.",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Geen winkelinformatie beschikbaar",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Je bent niet ingelogd, de chat verloopt als je afsluit.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Origineel adres niet gevonden",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Ander adres"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Wachtwoordtips:"),
    ...
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Naam en telefoonnummer bijwerken",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Sta toegang tot de locatie toe",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Product niet klaar voor nabestelling",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Productvariaties niet beschikbaar",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Regio\'s"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Relevantie"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Huurdata"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Zoek landen..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Verstuur bestelling via WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Je bestelling is ontvangen in het systeem en je kunt dezelfde bestelling via WhatsApp versturen.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopify-lid"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Moet cijfers en speciale tekens bevatten",
    ),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Topmerken"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Ongedefinieerd"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Adres bijwerken"),
    ...
    "updateInformationSuccess": MessageLookupByLibrary.simpleMessage(
      "Informatie succesvol bijgewerkt",
    ),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("Validatiefout"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Gebruik 2-letterige staatcodes (CA, NY, TX)\n• Gebruik 2-letterige landcodes (US, CA, GB)\n• Controleer het formaat van de postcode\n• Zorg dat alle verplichte velden zijn ingevuld",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "U moet inloggen om adressen te zien",
    ),
