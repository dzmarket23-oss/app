...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "A moeda ${currency} não é suportada pela sua conta Razorpay. Por favor, contacte o suporte para ativar pagamentos internacionais ou altere para uma moeda suportada.";
  ...
  static String m23(captcha) => "Introduza ${captcha} para confirmar:";
  ...
  static String m28(time) => "A expirar em ${time}";
  ...
  static String m34(size) => "Tamanho máximo do ficheiro: ${size} MB";
  ...
  static String m37(count) => "São necessários no mínimo ${count} caracteres";
  ...
  static String m46(price) => "Opções totais: ${price}";
  ...
  static String m52(percent) => "Desconto ${percent}%";
  ...
  static String m64(amount) => "Use ${amount} pontos";
  ...
  static String m72(length) => "Encontrámos ${length} produtos";

  static String m73(week) => "Semana ${week}";

  static String m74(name) => "Bem-vindo ${name}";

  static String m75(year) => "Há ${year} anos";

  static String m76(count) => "Está a selecionar ${count} item(ns)";

  static String m77(total) => "Atribuiu à encomenda nº${total}";

  static String m78(type) => "";

  static String m79(point) => "Tem ${point} pontos";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Alterar regularmente a sua palavra-passe ajuda a proteger a sua conta",
    ),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Adicionar, editar moradas de envio",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Tem a certeza que deseja terminar este chat?",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Não foi possível alterar a palavra-passe. Por favor, tente novamente.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Não é possível criar fatura para Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Não é possível criar encomenda para Razorpay",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Atualizar palavra-passe de segurança",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "O chat foi terminado. Por favor, inicie um novo chat.",
    ),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "O nome de exibição é gerado automaticamente a partir do primeiro e último nome",
    ),
    "distance": m21,
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Terminar Chat"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Introduza as informações do seu endereço",
    ),
    "enterYourCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "Introduza a sua localização atual",
    ),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Falha ao atualizar o endereço padrão",
    ),
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Tem alguma pergunta? Escreva-nos!",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ups! Não foi possível abrir este link.",
    ),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Chat em direto"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Sem internet. Reestabeleça a ligação para continuar a comprar.",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Não há informações disponíveis sobre a loja",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Não está autenticado, o chat irá expirar se sair.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Morada original não encontrada",
    ),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "Escolha o seu destino de envio.",
    ),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Por favor, adicione primeiro um endereço",
    ),
    ...
    "pleaseConfirmNewPassword": MessageLookupByLibrary.simpleMessage(
      "Por favor, confirme a sua nova palavra-passe",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produto não está pronto para nova encomenda",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Variações de produto não disponíveis",
    ),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Datas de aluguer"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "A sua encomenda foi recebida no sistema e pode enviar a mesma encomenda via WhatsApp.",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Precisa de iniciar sessão para ver os endereços",
    ),
