...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Sarafu ${currency} haiungwa mkono na akaunti yako ya Razorpay. Tafadhali wasiliana na msaada ili kuwezesha malipo ya kimataifa au ubadilishe kuwa sarafu inayoungwa mkono.";

  static String m20(day) => "Siku ${day} zilizopita";

  static String m21(total) => "~${total} kilomita";

  static String m22(timeLeft) => "Inaisha baada ya ${timeLeft}";

  static String m23(captcha) => "Weka ${captcha} ili kuthibitisha:";

  static String m24(message) => "Hitilafu: ${message}";

  static String m25(message) => "Hitilafu: ${message}";

  static String m26(error) => "Hitilafu imetokea: ${error}";

  static String m27(error) => "Hitilafu imetokea: ${error}";

  static String m28(time) => "Inaisha baada ya ${time}";

  static String m29(total) => "> kilomita${total} ";

  static String m30(hour) => "Saa ${hour} zilizopita";
  ...
  static String m34(size) => "Upeo wa ukubwa wa faili: ${size} MB";
  ...
  static String m37(count) => "Angalau herufi ${count} zinahitajika";
  ...
  static String m40(value) => "Kiwango cha chini cha muamala: ${value}";

  static String m41(minute) => "Dakika ${minute} zilizopita";

  static String m42(month) => "Miezi ${month} iliyopita";

  static String m43(store) => "Zaidi kutoka ${store}";

  static String m44(number) => "Lazima inunuliwe katika vikundi vya ${number}";

  static String m45(itemCount) => "Vitu ${itemCount}";

  static String m46(price) => "Jumla ya chaguo: ${price}";

  static String m47(amount) => "Lipa ${amount}";

  static String m48(name) => "${name} imeongezwa kwenye kikapu";

  static String m49(total) => "Kiasi: ${total}";

  static String m50(name) => "Umepokea pesa kutoka kwa ${name}";

  static String m51(count) =>
      "Je, ungependa kuondoa vipengee ${count} kutoka kwenye orodha yako ya matamanio?";

  static String m52(percent) => "Punguzo ${percent}%";

  static String m53(keyword) => "Matokeo ya utafutaji wa: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m55(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m56(second) => "Sekunde ${second} zilizopita";

  static String m57(totalCartQuantity) =>
      "Kikapu cha ununuzi, vitu ${totalCartQuantity}";

  static String m58(numberOfUnitsSold) => "Imeuzwa: ${numberOfUnitsSold}";

  static String m59(price) => "Inaanzia ${price}";

  static String m60(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m61(total) => "Jumla ya Bidhaa: ${total}";

  static String m62(name) => "Hamisha pesa kwa ${name}";

  static String m63(price) => "Hadi ${price}";

  static String m64(amount) => "Tumia pointi ${amount} ";
  ...
  static String m66(time) => "Itatumika hadi: ${time}";

  static String m67(date) => "Halali hadi ${date}";

  static String m68(number) => "Toleo la ${number}";

  static String m69(balance) => "Salio la Pochi: ${balance}";

  static String m70(message) => "Onyo: ${message}";
  ...
  static String m72(length) => "Tumepata bidhaa ${length}";

  static String m73(week) => "Wiki ${week}";

  static String m74(name) => "Karibu ${name}";

  static String m75(year) => "Miaka ${year} iliyopita";

  static String m76(count) => "Unachagua vipengee ${count} ";

  static String m77(total) => "Umepangiwa agizo #${total}";

  static String m78(type) => "Umepita ${type}";

  static String m79(point) => "Una pointi ${point}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Kubadilisha nenosiri lako mara kwa mara husaidia kulinda akaunti yako",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Una uhakika unataka kumaliza mazungumzo haya?",
    ),
    ...
    "available": MessageLookupByLibrary.simpleMessage("Inapatikana"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Haiwezekani kubadilisha nenosiri. Tafadhali jaribu tena.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Haiwezi kuunda ankara kwa Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Haiwezi kuunda oda kwa Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Mazungumzo yameisha. Tafadhali anza mazungumzo mapya.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("ChatGPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Ujumbe"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Tuma Ujumbe Sasa"),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("nchi"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage(
      "Anwani Chaguo-msingi",
    ),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Anwani chaguo-msingi imesasishwa kikamilifu",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Chaguo-msingi"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Jina la kuonekana linaundwa kiotomatiki kutoka kwa jina la kwanza na la mwisho",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Hariri Anwani"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Maliza Mazungumzo"),
    ...
    "enterYourName": MessageLookupByLibrary.simpleMessage("Weka jina lako"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Hitilafu"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Imeshindwa kusasisha anwani chaguo-msingi",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Samahani! Hatukuweza kufungua kiungo hiki.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("inahitajika"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage(
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("Jina linahitajika"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Nenosiri Mpya"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Hakuna intaneti. Unganisha upya ili kuendelea kununua.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Hakuna bidhaa zilizopatikana kwenye oda hii",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Hakuna taarifa ya duka inayopatikana",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Hujaingia, mazungumzo yataisha ukitoka.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Anwani asili haikupatikana",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Anwani Nyingine"),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Tafadhali ongeza anwani kwanza",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Tafadhali ruhusu upatikanaji wa eneo",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Tafadhali angalia masuala yafuatayo:",
    ),
    ...
    "pleaseConfirmNewPassword": MessageLookupByLibrary.simpleMessage(
      "Tafadhali thibitisha nenosiri lako jipya",
    ),
    "pleaseEnterCurrentPassword": MessageLookupByLibrary.simpleMessage(
      "Tafadhali ingiza nenosiri lako la sasa",
    ),
    ...
    "pleaseEnterLastName": MessageLookupByLibrary.simpleMessage(
      "Tafadhali ingiza jina la mwisho",
    ),
    "pleaseEnterNewPassword": MessageLookupByLibrary.simpleMessage(
      "Tafadhali ingiza nenosiri lako jipya",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Bidhaa haiko tayari kuagizwa tena",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Kanda"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Uhusiano"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Tafuta nchi..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Tuma oda kupitia WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Oda yako imepokelewa kwenye mfumo na unaweza kutuma oda hiyo hiyo kupitia WhatsApp.",
    ),
    ...
    "shopifyAccountManagement": MessageLookupByLibrary.simpleMessage(
      "Usimamizi wa Akaunti ya Shopify",
    ),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Inapaswa kuwa na nambari na alama maalum",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• Inapaswa kuwa na herufi kubwa na ndogo",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Anza Mazungumzo"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Vidokezo:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Bidhaa Maarufu"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Aina"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Haijafafanuliwa"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Sasisha Anwani"),
    ...
    "updateYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Sasisha taarifa za anwani yako",
    ),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Tumia misimbo ya majimbo yenye herufi 2 (CA, NY, TX)\n• Tumia misimbo ya nchi yenye herufi 2 (US, CA, GB)\n• Hakikisha muundo wa nambari ya posta/ZIP\n• Hakikisha sehemu zote muhimu zimejazwa",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Unahitaji kuingia ili kuona anwani",
    ),
