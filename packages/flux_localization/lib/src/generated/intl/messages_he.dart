...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "המטבע ${currency} אינו נתמך על ידי חשבון Razorpay שלך. אנא פנה לתמיכה כדי להפעיל תשלומים בינלאומיים או החלף למטבע נתמך.";

  static String m20(day) => "לפני ${day} ימים";

  static String m21(total) => "~${total} ק\"מ";

  static String m22(timeLeft) => "מסתיים בעוד ${timeLeft}";

  static String m23(captcha) => "הזן ${captcha} לאישור:";

  static String m24(message) => "שגיאה: ${message}";

  static String m25(message) => "שגיאה: ${message}";

  static String m26(error) => "אירעה שגיאה: ${error}";

  static String m27(error) => "אירעה שגיאה: ${error}";

  static String m28(time) => "יפוג בעוד ${time}";

  static String m29(total) => "יותר מ-${total} ק\"מ";

  static String m30(hour) => "לפני ${hour} שעות";

  static String m31(currentBalance) => "נותרו לך רק ${currentBalance} בארנק";
  ...
  static String m34(size) => "גודל קובץ מקסימלי: ${size} מגה בייט";
  ...
  static String m37(count) => "נדרשים לפחות ${count} תווים";
  ...
  static String m39(amount) => "קופון זה דורש רכישה מינימלית של ${amount}.";

  static String m40(value) => "עסקה מינימלית: ${value}";

  static String m41(minute) => "לפני ${minute} דקות";

  static String m42(month) => "לפני ${month} חודשים";

  static String m43(store) => "עוד מ-${store}";

  static String m44(number) => "חייב להירכש בקבוצות של ${number}";

  static String m45(itemCount) => "${itemCount} פריטים";

  static String m46(price) => "סה״כ אפשרויות: ${price}";

  static String m47(amount) => "שלם ${amount}";

  static String m48(name) => "${name} נוסף לעגלה בהצלחה";

  static String m49(total) => "כמות: ${total}";

  static String m50(name) => "התקבל תשלום מ-${name}";

  static String m51(count) =>
      "האם ברצונך להסיר ${count} פריטים מרשימת המשאלות?";

  static String m52(percent) => "הנחה ${percent}%";

  static String m53(keyword) => "תוצאות חיפוש עבור: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} פריט)";

  static String m55(keyword, count) => "${keyword} (${count} פריטים)";

  static String m56(second) => "לפני ${second} שניות";

  static String m57(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m58(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m59(price) => "החל מ-${price}";

  static String m60(fieldName) => "השדה ${fieldName} נדרש";

  static String m61(total) => "${total} מוצרים";

  static String m62(name) => "העבר כסף אל ${name}";

  static String m63(price) => "עד ${price}";

  static String m64(amount) => "השתמש ב-${amount} נקודות";
  ...
  static String m66(time) => "בתוקף עד: ${time}";

  static String m67(date) => "תקף עד ${date}";

  static String m68(number) => "גרסה ${number}";

  static String m69(balance) => "יתרת ארנק: ${balance}";

  static String m70(message) => "אזהרה: ${message}";

  static String m71(defaultCurrency) =>
      "המטבע שנבחר כרגע אינו זמין עבור תכונת הארנק, אנא שנה אותו ל-${defaultCurrency}";

  static String m72(length) => "מצאנו ${length} מוצרים";

  static String m73(week) => "שבוע ${week}";

  static String m74(name) => "ברוך הבא ${name}";

  static String m75(year) => "לפני ${year} שנים";

  static String m76(count) => "אתה בוחר ${count} פריטים";

  static String m77(total) => "הוקצית להזמנה מספר ${total}";

  static String m78(type) => "עברת את ${type}";

  static String m79(point) => "יש לך ${point} נקודות";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("אבטחת חשבון"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "שינוי הסיסמה שלך באופן קבוע עוזר להגן על החשבון שלך",
    ),
    ...
    "addressManagement": MessageLookupByLibrary.simpleMessage("ניהול כתובות"),
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "הוסף, ערוך כתובות משלוח",
    ),
    "addressNotFound": MessageLookupByLibrary.simpleMessage("הכתובת לא נמצאה"),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "האם אתה בטוח שברצונך לסיים את הצ\'אט הזה?",
    ),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("מותגים במחיר נמוך"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "לא ניתן לשנות את הסיסמה. אנא נסה שוב.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "לא ניתן ליצור חשבונית עבור Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "לא ניתן ליצור הזמנה עבור Razorpay",
    ),
    ...
    "contactInformation": MessageLookupByLibrary.simpleMessage("פרטי קשר"),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("מדינות"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("כתובת ברירת מחדל"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "כתובת ברירת מחדל עודכנה בהצלחה",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("ברירת מחדל"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "שם התצוגה נוצר אוטומטית משם פרטי ומשפחה",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("ערוך כתובת"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("סיים צ\'אט"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("שגיאה"),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "אופס! לא הצלחנו לפתוח את הקישור הזה.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("נדרש"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("צ\'אט חי"),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("יש צורך בשם"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("סיסמה חדשה"),
    ...
    "noAddressesFound": MessageLookupByLibrary.simpleMessage("לא נמצאו כתובות"),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("אין שם תצוגה"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ אין חיבור לאינטרנט. התחבר מחדש כדי להמשיך לקנות.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "הכתובת המקורית לא נמצאה",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("כתובת אחרת"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("טיפים לסיסמה:"),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("אזורים"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("רלוונטיות"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("תאריכי השכרה"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("כתובות שמורות"),
    "savedToGallery": MessageLookupByLibrary.simpleMessage("נשמר בגלריה"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("חפש מדינות..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "שלח הזמנה דרך WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "ההזמנה שלך התקבלה במערכת ואתה יכול לשלוח את אותה הזמנה דרך WhatsApp.",
    ),
    ...
    "setAsDefault": MessageLookupByLibrary.simpleMessage("הגדר כברירת מחדל"),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("חבר Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• צריכה לכלול מספרים ותווים מיוחדים",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• צריכה לכלול אותיות גדולות וקטנות",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("התחל צ\'אט"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("טיפים:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("מותגים מובילים"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("סוגים"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("לא מוגדר"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("עדכן כתובת"),
    "updateFailed": MessageLookupByLibrary.simpleMessage("העדכון נכשל!"),
    "updateInfo": MessageLookupByLibrary.simpleMessage("עדכן מידע"),
    "updateInformation": MessageLookupByLibrary.simpleMessage("עדכן פרטים"),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("שגיאת אימות"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• השתמש בקודי מדינה בני 2 אותיות (CA, NY, TX)\n• השתמש בקודי מדינה בני 2 אותיות (US, CA, GB)\n• בדוק את פורמט המיקוד/קוד דואר\n• ודא שכל השדות הנדרשים מלאים",
    ),
