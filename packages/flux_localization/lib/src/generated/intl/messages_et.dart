...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Valuuta ${currency} ei ole teie Razorpay kontol toetatud. Palun võtke ühendust klienditoega, et lubada rahvusvahelised maksed või vahetage toetatud valuuta vastu.";

  static String m20(day) => "${day} päeva tagasi";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Lõppeb ${timeLeft} pärast";

  static String m23(captcha) => "Sisesta kinnitamiseks ${captcha}:";

  static String m24(message) => "Viga: ${message}";

  static String m25(message) => "Viga: ${message}";

  static String m26(error) => "Tekkis viga: ${error}";

  static String m27(error) => "Tekkis viga: ${error}";

  static String m28(time) => "Aegub ${time} pärast";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} tundi tagasi";
  ...
  static String m34(size) => "Maksimaalne faili suurus: ${size} MB";
  ...
  static String m37(count) => "Vajalik on vähemalt ${count} tähemärki";
  ...
  static String m40(value) => "Min tehing: ${value}";

  static String m41(minute) => "${minute} minutit tagasi";

  static String m42(month) => "${month} kuud tagasi";

  static String m43(store) => "Rohkem poest ${store}";

  static String m44(number) => "Peab ostma ${number} kaupa";

  static String m45(itemCount) => "${itemCount} toodet";

  static String m46(price) => "Valikute kogusumma: ${price}";

  static String m47(amount) => "Maksa ${amount}";

  static String m48(name) => "${name} on lisatud ostukorvi";

  static String m49(total) => "Kogus: ${total}";

  static String m50(name) => "Sai raha kasutajalt ${name}";

  static String m51(count) =>
      "Kas soovid eemaldada ${count} eset oma soovinimekirjast?";

  static String m52(percent) => "Müügil ${percent}%";

  static String m53(keyword) => "Otsingutulemused: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} ese)";

  static String m55(keyword, count) => "${keyword} (${count} eset)";

  static String m56(second) => "${second} sekundit tagasi";

  static String m57(totalCartQuantity) =>
      "Ostukorv, ${totalCartQuantity} toodet";

  static String m58(numberOfUnitsSold) => "Müüdud: ${numberOfUnitsSold}";

  static String m59(price) => "Alates ${price}";

  static String m60(fieldName) => "Väli ${fieldName} on kohustuslik";

  static String m61(total) => "${total} toodet";

  static String m62(name) => "Kanna raha üle kasutajale ${name}";

  static String m63(price) => "Kuni ${price}";

  static String m64(amount) => "Kasuta ${amount} punkti";
  ...
  static String m66(time) => "Kehtib kuni: ${time}";

  static String m67(date) => "Kehtib kuni ${date}";

  static String m68(number) => "Versioon ${number}";

  static String m69(balance) => "Rahakoti saldo: ${balance}";

  static String m70(message) => "Hoiatus: ${message}";
  ...
  static String m72(length) => "Leidsime ${length} toodet";

  static String m73(week) => "Nädal ${week}";

  static String m74(name) => "Tere tulemast, ${name}";

  static String m75(year) => "${year} aastat tagasi";

  static String m76(count) => "Valite ${count} eset";

  static String m77(total) => "Oled määratud tellimusele #${total}";

  static String m78(type) => "Oled läbinud ${type}";

  static String m79(point) => "Sul on ${point} punkti";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Konto turvalisus"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Parooli regulaarne vahetamine aitab kaitsta sinu kontot",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Kas oled kindel, et soovid selle vestluse lõpetada?",
    ),
    ...
    "available": MessageLookupByLibrary.simpleMessage("Saadaval"),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Brändid soodsamalt"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Parooli ei saa muuta. Palun proovi uuesti.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Ei saa Razorpay jaoks arvet luua",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Ei saa Razorpay jaoks tellimust luua",
    ),
    ...
    "contactInformation": MessageLookupByLibrary.simpleMessage("Kontaktandmed"),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("riigid"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Vaikimisi aadress"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Vaikimisi aadress edukalt uuendatud",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Vaikimisi"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Kuvatav nimi luuakse automaatselt ees- ja perekonnanime põhjal",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Muuda aadressi"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Lõpeta vestlus"),
    ...
    "enterYourName": MessageLookupByLibrary.simpleMessage("Sisesta oma nimi"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Viga"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Vaikimisi aadressi uuendamine ebaõnnestus",
    ),
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Kas sul on küsimus? Kirjuta meile!",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Oih! Me ei saanud seda linki avada.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("on kohustuslik"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Reaalajas vestlus"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Uus parool"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Internet puudub. Ühenda uuesti, et ostlemist jätkata.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Selle tellimuse kohta ei leitud ühtegi toodet",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Sa ei ole sisse logitud, vestlus aegub kui lahkud.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Algset aadressi ei leitud",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Muu aadress"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Parooli soovitused:"),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Palun luba juurdepääs asukohale",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Palun kontrolli järgmisi probleeme:",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Toode pole korduvtellimiseks valmis",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Toote variatsioone pole saadaval",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Piirkonnad"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Asjakohasus"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Rendikuupäevad"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Otsi riike..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Saada tellimus WhatsAppi kaudu",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Sinu tellimus on süsteemis vastu võetud ja saad sama tellimuse saata ka WhatsAppi kaudu.",
    ),
    ...
    "setAsDefault": MessageLookupByLibrary.simpleMessage("Määra vaikimisi"),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopify liige"),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Alusta vestlust"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Näpunäited:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Parimad brändid"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Tüübid"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Määramata"),
    "undo": MessageLookupByLibrary.simpleMessage("Võta tagasi"),
    "unexpectedError": MessageLookupByLibrary.simpleMessage(
      "Tekkis ootamatu viga. Palun proovi uuesti.",
    ),
    "unknown": MessageLookupByLibrary.simpleMessage("Tundmatu"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Uuenda aadressi"),
    ...
    "updateInformation": MessageLookupByLibrary.simpleMessage("Uuenda andmeid"),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("Valideerimisviga"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Kasuta 2-tähelisi osariigi koode (CA, NY, TX)\n• Kasuta 2-tähelisi riigikoode (US, CA, GB)\n• Kontrolli postiindeksi/ZIP-koodi vormingut\n• Veendu, et kõik kohustuslikud väljad on täidetud",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Aadresside nägemiseks pead sisse logima",
    ),
