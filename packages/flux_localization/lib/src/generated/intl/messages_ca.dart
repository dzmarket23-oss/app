...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "La moneda ${currency} no és compatible amb el teu compte de Razorpay. Si us plau, contacta amb el suport per activar els pagaments internacionals o canvia a una moneda compatible.";

  static String m20(day) => "fa ${day} dies";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Acaba en ${timeLeft}";

  static String m23(captcha) => "Introdueix ${captcha} per confirmar:";

  static String m24(message) => "Error: ${message}";

  static String m25(message) => "Error: ${message}";

  static String m26(error) => "S\'ha produït un error: ${error}";

  static String m27(error) => "S\'ha produït un error: ${error}";

  static String m28(time) => "Caduca en ${time}";

  static String m29(total) => "Més de ${total} km";

  static String m30(hour) => "fa ${hour} hores";
  ...
  static String m34(size) => "Mida màxima del fitxer: ${size} MB";
  ...
  static String m37(count) => "Es requereixen un mínim de ${count} caràcters";
  ...
  static String m40(value) => "Transacció mínima: ${value}";

  static String m41(minute) => "fa ${minute} minuts";

  static String m42(month) => "Fa ${month} mesos";

  static String m43(store) => "Més de ${store}";

  static String m44(number) => "s\'ha de comprar en grups de ${number}";

  static String m45(itemCount) => "${itemCount} articles";

  static String m46(price) => "Total d\'opcions: ${price}";

  static String m47(amount) => "Pagar ${amount}";

  static String m48(name) => " S\'han afegit${name} al carretó correctament";

  static String m49(total) => "Quantitat: ${total}";

  static String m50(name) => "S\'ha rebut diners de ${name}";

  static String m51(count) =>
      "Vols eliminar ${count} element(s) de la teva llista de desitjos?";

  static String m52(percent) => "${percent}% de descompte";

  static String m53(keyword) => "Resultats de la cerca per a: \"${keyword}\"";

  static String m54(keyword, count) => "${keyword} (${count} element)";

  static String m55(keyword, count) => "${keyword} (${count} elements)";

  static String m56(second) => "fa ${second} segons";

  static String m57(totalCartQuantity) =>
      "Carret de compra, ${totalCartQuantity} articles";

  static String m58(numberOfUnitsSold) => "Venut: ${numberOfUnitsSold}";

  static String m59(price) => "A partir de ${price}";

  static String m60(fieldName) => "El camp ${fieldName} és obligatori";

  static String m61(total) => "${total} productes";

  static String m62(name) => "Transfereix diners a ${name}";

  static String m63(price) => "Fins a ${price}";

  static String m64(amount) => "Utilitza ${amount} punts";
  ...
  static String m66(time) => "Vàlid fins: ${time}";

  static String m67(date) => "Vàlid fins al ${date}";

  static String m68(number) => "Versió ${number}";

  static String m69(balance) => "Saldo de Wallet: ${balance}";

  static String m70(message) => "Avís: ${message}";
  ...
  static String m72(length) => "Hem trobat ${length} productes";

  static String m73(week) => "Setmana ${week}";

  static String m74(name) => "Benvingut/da ${name}";

  static String m75(year) => "Fa ${year} anys";

  static String m76(count) => "Estàs seleccionant ${count} element(s)";

  static String m77(total) => "T\'han assignat la comanda #${total}";

  static String m78(type) => "Has superat ${type}";

  static String m79(point) => "Tens ${point} punts";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Canviar la contrasenya regularment ajuda a protegir el teu compte",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Estàs segur que vols acabar aquest xat?",
    ),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Marques per menys"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "No es pot canviar la contrasenya. Torna-ho a provar.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "No es pot crear la factura per a Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "No es pot crear la comanda per a Razorpay",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Actualitza la contrasenya de seguretat",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "El xat s\'ha acabat. Si us plau, inicia un nou xat.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Missatges"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Xateja ara"),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("països"),
    ...
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "L\'adreça per defecte s\'ha actualitzat correctament",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Per defecte"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "El nom visible es genera automàticament a partir del nom i cognom",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Edita l\'adreça"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Finalitza el xat"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Introdueix la informació de la teva adreça",
    ),
    "enterYourCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "Introdueix la teva ubicació actual",
    ),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "No s\'ha pogut actualitzar l\'adreça per defecte",
    ),
    ...
    "generalError": MessageLookupByLibrary.simpleMessage(
      "Alguna cosa ha fallat. Torna-ho a intentar.",
    ),
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Tens alguna pregunta? Escriu-nos!",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Vaja! No hem pogut obrir aquest enllaç.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("és obligatori"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Xat en directe"),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("Sense nom visible"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Sense internet. Torna a connectar per continuar comprant.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "No s\'han trobat productes en aquesta comanda",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "No hi ha informació disponible de la botiga",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "No has iniciat sessió, el xat caducarà si surts.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "No s\'ha trobat l\'adreça original",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Altra adreça"),
    ...
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Actualitza el nom, número de telèfon",
    ),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "Tria la teva destinació d\'enviament.",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Si us plau, permet l\'accés a la ubicació",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Comprova els següents problemes:",
    ),
    ...
    "pleaseEnterCurrentPassword": MessageLookupByLibrary.simpleMessage(
      "Introdueix la teva contrasenya actual, si us plau",
    ),
    ...
    "pleaseEnterLastName": MessageLookupByLibrary.simpleMessage(
      "Si us plau, introdueix el cognom",
    ),
    "pleaseEnterNewPassword": MessageLookupByLibrary.simpleMessage(
      "Introdueix la teva nova contrasenya, si us plau",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "El producte no està preparat per tornar a demanar",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Variacions del producte no disponibles",
    ),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Rellevància"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Dates de lloguer"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Adreces desades"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Cerca països..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Envia la comanda per WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "La teva comanda s\'ha rebut al sistema i pots enviar la mateixa comanda per WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Membre de Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Ha de contenir números i caràcters especials",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Inicia el xat"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Consells:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Marques destacades"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Tipus"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Indefinit"),
    ...
    "updateYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Actualitza la informació de la teva adreça",
    ),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Utilitza codis d\'estat de 2 lletres (CA, NY, TX)\n• Utilitza codis de país de 2 lletres (US, CA, GB)\n• Comprova el format del codi postal\n• Assegura\'t que tots els camps obligatoris estiguin omplerts",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Has d\'iniciar sessió per veure les adreces",
    ),
