...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Waluta ${currency} nie jest obsługiwana przez Twoje konto Razorpay. Skontaktuj się z pomocą techniczną, aby włączyć płatności międzynarodowe lub zmień na obsługiwaną walutę.";

  static String m20(day) => "${day} dni temu";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Kończy się za ${timeLeft}";

  static String m23(captcha) => "Wpisz ${captcha}, aby potwierdzić:";

  static String m24(message) => "Błąd: ${message}";

  static String m25(message) => "Błąd: ${message}";

  static String m26(error) => "Wystąpił błąd: ${error}";

  static String m27(error) => "Wystąpił błąd: ${error}";

  static String m28(time) => "Wygasa za ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} godz. temu";
  ...
  static String m34(size) => "Maksymalny rozmiar pliku: ${size} MB";
  ...
  static String m37(count) => "Wymagane minimum ${count} znaków";
  ...
  static String m40(value) => "Minimalna transakcja: ${value}";

  static String m41(minute) => "${minute} min temu";

  static String m42(month) => "${month} miesięcy temu";

  static String m43(store) => "Więcej od ${store}";

  static String m44(number) => "Musi być kupowane w grupach po ${number}";

  static String m45(itemCount) => "${itemCount} elementów";

  static String m46(price) => "Suma opcji: ${price}";

  static String m47(amount) => "Zapłać ${amount}";

  static String m48(name) => "Produkt ${name} został dodany do koszyka";

  static String m49(total) => "Ilość: ${total}";

  static String m50(name) => "Otrzymano środki od ${name}";

  static String m51(count) =>
      "Czy chcesz usunąć ${count} pozycji z listy życzeń?";

  static String m52(percent) => "Wyprzedaż ${percent}%";

  static String m53(keyword) => "Wyniki wyszukiwania dla: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} element)";

  static String m55(keyword, count) => "${keyword} (${count} elementów)";

  static String m56(second) => "${second} sekund temu";

  static String m57(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycji";

  static String m58(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m59(price) => "Cena od ${price}";

  static String m60(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m61(total) => "${total} produktów";

  static String m62(name) => "Przelej pieniądze do ${name}";

  static String m63(price) => "Do ${price}";

  static String m64(amount) => "Użyj ${amount} punktów";
  ...
  static String m66(time) => "Ważne do: ${time}";

  static String m67(date) => "Ważne do ${date}";

  static String m68(number) => "Wersja ${number}";

  static String m69(balance) => "Saldo portfela: ${balance}";

  static String m70(message) => "Ostrzeżenie: ${message}";
  ...
  static String m72(length) => "Znaleźliśmy ${length} produktów";

  static String m73(week) => "Tydzień ${week}";

  static String m74(name) => "Witaj ${name}";

  static String m75(year) => "${year} lat temu";

  static String m76(count) => "Wybierasz ${count} produktów";

  static String m77(total) => "Przypisano do zamówienia nr ${total}";

  static String m78(type) => "Zdałeś ${type}";

  static String m79(point) => "Masz ${point} punktów";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Regularna zmiana hasła pomaga chronić Twoje konto",
    ),
    ...
    "addressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Adres został zaktualizowany pomyślnie",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Czy na pewno chcesz zakończyć ten czat?",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Nie można utworzyć faktury dla Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Nie można utworzyć zamówienia dla Razorpay",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Zaktualizuj hasło zabezpieczające",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Czat został zakończony. Rozpocznij nowy czat.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Wiadomości"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Rozpocznij czat"),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("kraje"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Domyślny adres"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Domyślny adres został pomyślnie zaktualizowany",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Domyślny"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Nazwa wyświetlana jest automatycznie generowana z imienia i nazwiska",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Edytuj adres"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Zakończ czat"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Wpisz informacje o adresie",
    ),
    "enterYourCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "Wprowadź swoją aktualną lokalizację",
    ),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Błąd"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Nie udało się zaktualizować domyślnego adresu",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ups! Nie udało się otworzyć tego linku.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("jest wymagane"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Czat na żywo"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Nowe hasło"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Brak internetu. Połącz się ponownie, aby kontynuować zakupy.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Nie znaleziono produktów w tym zamówieniu",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Brak dostępnych informacji o sklepie",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Nie jesteś zalogowany, czat wygaśnie po wyjściu.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Nie znaleziono oryginalnego adresu",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Inny adres"),
    ...
    "personalInformation": MessageLookupByLibrary.simpleMessage("Dane osobowe"),
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Zaktualizuj imię, numer telefonu",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produkt nie jest gotowy do ponownego zamówienia",
    ),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Trafność"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Daty wynajmu"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Zapisane adresy"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Szukaj krajów..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Wyślij zamówienie przez WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Twoje zamówienie zostało przyjęte w systemie i możesz wysłać to samo zamówienie przez WhatsApp.",
    ),
    ...
    "setAsDefault": MessageLookupByLibrary.simpleMessage("Ustaw jako domyślny"),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Członek Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Powinno zawierać cyfry i znaki specjalne",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Rozpocznij czat"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Wskazówki:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Najlepsze marki"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Nieokreślono"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Aktualizuj adres"),
    ...
    "updateInformationSuccess": MessageLookupByLibrary.simpleMessage(
      "Informacje zostały pomyślnie zaktualizowane",
    ),
    ...
    "updateYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Zaktualizuj informacje o adresie",
    ),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("Błąd walidacji"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Używaj dwuliterowych kodów stanów (CA, NY, TX)\n• Używaj dwuliterowych kodów krajów (US, CA, GB)\n• Sprawdź format kodu pocztowego\n• Upewnij się, że wszystkie wymagane pola są wypełnione",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Musisz się zalogować, aby zobaczyć adresy",
    ),
