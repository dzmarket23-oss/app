...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(captcha) => "输入${captcha}以确认：";
  ...
  static String m44(number) => "必须以${number}为一组购买";
  ...
  static String m48(name) => "${name}已添加到购物车";

  static String m49(total) => "数量：${total}";

  static String m50(name) => "已收到来自${name}的款项";

  static String m51(count) => "是否要从愿望清单中删除 ${count} 件商品？";

  static String m52(percent) => "促销 ${percent}%";

  static String m53(keyword) => "\"${keyword}\"的搜索结果";

  static String m54(keyword, count) => "${keyword}（${count}个结果）";

  static String m55(keyword, count) => "${keyword}（${count}个结果）";
  ...
  static String m61(total) => "${total}件商品";
  ...
  static String m72(length) => "我们找到了${length}件商品";
  ...
  static String m76(count) => "您正在选择 ${count} 个项目";

  static String m77(total) => "您已分配到订单#${total}";
