...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "${currency} para birimi Razorpay hesabınız tarafından desteklenmiyor. Lütfen uluslararası ödemeleri etkinleştirmek için destek ile iletişime geçin veya desteklenen bir para birimine geçin.";

  static String m20(day) => "${day} gün önce";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Biter: ${timeLeft}";

  static String m23(captcha) => "Doğrulamak için ${captcha} girin:";

  static String m24(message) => "Hata: ${message}";

  static String m25(message) => "Hata: ${message}";

  static String m26(error) => "Bir hata oluştu: ${error}";

  static String m27(error) => "Bir hata oluştu: ${error}";

  static String m28(time) => "${time} içinde sona eriyor";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} saat önce";
  ...
  static String m34(size) => "Maksimum dosya boyutu: ${size} MB";
  ...
  static String m37(count) => "En az ${count} karakter gerekli";
  ...
  static String m40(value) => "Min işlem: ${value}";

  static String m41(minute) => "${minute} dakika önce";

  static String m42(month) => "${month} ay önce";

  static String m43(store) => "${store} mağazasından daha fazlası";

  static String m44(number) =>
      "${number} adetlik gruplar halinde satın alınmalıdır";

  static String m45(itemCount) => "${itemCount} ürün";

  static String m46(price) => "Toplam seçenek: ${price}";

  static String m47(amount) => "${amount} ile öde";

  static String m48(name) => "${name} sepete eklendi";

  static String m49(total) => "Adet: ${total}";

  static String m50(name) => "${name} tarafından para alındı";

  static String m51(count) =>
      "İstek listenizden ${count} ürünü kaldırmak istiyor musunuz?";

  static String m52(percent) => "%${percent} İndirim";

  static String m53(keyword) => "\'${keyword}\' için arama sonuçları";

  static String m54(keyword, count) => "${keyword} (${count} ürün)";

  static String m55(keyword, count) => "${keyword} (${count} ürün)";

  static String m56(second) => "${second} saniye önce";

  static String m57(totalCartQuantity) => "Sepet, ${totalCartQuantity} ürün";

  static String m58(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m59(price) => "${price} başlangıç fiyatı";

  static String m60(fieldName) => "${fieldName} alanı zorunludur";

  static String m61(total) => "${total} ürün";

  static String m62(name) => "${name} hesabına para transferi";

  static String m63(price) => "En fazla ${price}";

  static String m64(amount) => " ${amount} puan kullan";
  ...
  static String m66(time) => "Geçerlilik tarihi: ${time}";

  static String m67(date) => "${date} tarihine kadar geçerli";

  static String m68(number) => "Sürüm ${number}";

  static String m69(balance) => "Cüzdan bakiyesi: ${balance}";

  static String m70(message) => "Uyarı: ${message}";
  ...
  static String m72(length) => "${length} Ürün Bulundu";

  static String m73(week) => "${week}. hafta";

  static String m74(name) => "Hoş geldin ${name}";

  static String m75(year) => "${year} yıl önce";

  static String m76(count) => "${count} ürün seçiyorsunuz";

  static String m77(total) => "#${total} numaralı siparişe atandınız";

  static String m78(type) => " ${type}geçtiniz";

  static String m79(point) => "${point} Puanınız Var";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Hesap Güvenliği"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Şifrenizi düzenli olarak değiştirmek hesabınızı korumaya yardımcı olur",
    ),
    ...
    "addressManagement": MessageLookupByLibrary.simpleMessage("Adres Yönetimi"),
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Kargo adreslerini ekle, düzenle",
    ),
    "addressNotFound": MessageLookupByLibrary.simpleMessage("Adres bulunamadı"),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Bu sohbeti bitirmek istediğinizden emin misiniz?",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Şifre değiştirilemiyor. Lütfen tekrar deneyin.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Razorpay için fatura oluşturulamıyor",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Razorpay için sipariş oluşturulamıyor",
    ),
    ...
    "changePassword": MessageLookupByLibrary.simpleMessage("Şifreyi Değiştir"),
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Güvenlik şifresini güncelle",
    ),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Varsayılan Adres"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Varsayılan adres başarıyla güncellendi",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Varsayılan"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Görünen ad, ad ve soyadınızdan otomatik olarak oluşturulur",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Adresi Düzenle"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Sohbeti Bitir"),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("gerekli"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Canlı Sohbet"),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("İsim gerekli"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Yeni Şifre"),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("Görünen ad yok"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ İnternet yok. Alışverişe devam etmek için yeniden bağlanın.",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Giriş yapmadınız, çıkarsanız sohbet sona erecek.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Orijinal adres bulunamadı",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Diğer Adres"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Şifre ipuçları:"),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Lütfen konum erişimine izin verin",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Lütfen aşağıdaki sorunları kontrol edin:",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Ürün tekrar siparişe hazır değil",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Ürün varyasyonları mevcut değil",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Bölgeler"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Alaka düzeyi"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Kiralama tarihleri"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Kayıtlı Adresler"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Ülkeleri ara..."),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Siparişiniz sisteme alındı ve aynı siparişi WhatsApp üzerinden gönderebilirsiniz.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopify Üyesi"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Rakamlar ve özel karakterler içermeli",
    ),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("İpuçları:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("En İyi Markalar"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Türler"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Adresi Güncelle"),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("Doğrulama Hatası"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• 2 harfli eyalet kodları kullanın (CA, NY, TX)\n• 2 harfli ülke kodları kullanın (US, CA, GB)\n• Posta kodu/ZIP formatını kontrol edin\n• Tüm gerekli alanların doldurulduğundan emin olun",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Adresleri görmek için giriş yapmanız gerekiyor",
    ),
