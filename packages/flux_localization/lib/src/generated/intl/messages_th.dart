...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(day) => "${day} วันที่แล้ว";

  static String m21(total) => "~${total} กม.";

  static String m22(timeLeft) => "จะสิ้นสุดใน ${timeLeft}";

  static String m23(captcha) => "ป้อน ${captcha} เพื่อยืนยัน:";

  static String m24(message) => "ข้อผิดพลาด: ${message}";

  static String m25(message) => "ข้อผิดพลาด: ${message}";

  static String m26(error) => "เกิดข้อผิดพลาด: ${error}";

  static String m27(error) => "เกิดข้อผิดพลาด: ${error}";

  static String m28(time) => "จะหมดอายุใน ${time}";

  static String m29(total) => ">${total} กม.";

  static String m30(hour) => "${hour} ชั่วโมงที่แล้ว";
  ...
  static String m34(size) => "ขนาดไฟล์สูงสุด: ${size} MB";
  ...
  static String m37(count) => "ต้องมีอย่างน้อย ${count} ตัวอักษร";
  ...
  static String m39(amount) => "คูปองนี้กำหนดให้ต้องซื้อขั้นต่ำ ${amount}";

  static String m40(value) => "ธุรกรรมขั้นต่ำ: ${value}";

  static String m41(minute) => "${minute} นาทีที่แล้ว";

  static String m42(month) => "${month} เดือนที่แล้ว";

  static String m43(store) => "สินค้าเพิ่มเติมจาก ${store}";

  static String m44(number) => "ต้องซื้อเป็นกลุ่มจำนวน ${number}";

  static String m45(itemCount) => "${itemCount} รายการ";

  static String m46(price) => "ราคารวมตัวเลือก: ${price}";

  static String m47(amount) => "ชำระเงิน ${amount}";

  static String m48(name) => " เพิ่ม${name} ลงในรถเข็นเรียบร้อยแล้ว";

  static String m49(total) => "จำนวน: ${total}";

  static String m50(name) => "ได้รับเงินจาก ${name}";

  static String m51(count) =>
      "คุณต้องการลบรายการ ${count} รายการออกจากรายการสิ่งที่อยากได้ของคุณหรือไม่?";

  static String m52(percent) => "ลด ${percent}%";

  static String m53(keyword) => "ผลการค้นหาสำหรับ: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} รายการ)";

  static String m55(keyword, count) => "${keyword} (${count} รายการ)";

  static String m56(second) => "${second} วินาทีที่แล้ว";

  static String m57(totalCartQuantity) =>
      "ตะกร้าสินค้า, ${totalCartQuantity} รายการ";

  static String m58(numberOfUnitsSold) => "ขายแล้ว: ${numberOfUnitsSold}";

  static String m59(price) => "เริ่มต้นที่ ${price}";

  static String m60(fieldName) => "ต้องกรอกช่อง ${fieldName}";

  static String m61(total) => "สินค้าทั้งหมด ${total} รายการ";

  static String m62(name) => "โอนเงินไปที่ ${name}";

  static String m63(price) => "สูงสุด ${price}";

  static String m64(amount) => "ใช้ ${amount} คะแนน";
  ...
  static String m66(time) => "ใช้ได้ถึงวันที่: ${time}";

  static String m67(date) => "ใช้ได้จนถึง ${date}";

  static String m68(number) => "เวอร์ชัน ${number}";

  static String m69(balance) => "ยอดเงินในกระเป๋าเงิน: ${balance}";

  static String m70(message) => "คำเตือน: ${message}";

  static String m71(defaultCurrency) =>
      "สกุลเงินที่เลือกไม่สามารถใช้กับคุณสมบัติกระเป๋าเงินได้ กรุณาเปลี่ยนเป็น ${defaultCurrency}";

  static String m72(length) => "เราพบสินค้า ${length} รายการ";

  static String m73(week) => "สัปดาห์ที่ ${week}";

  static String m74(name) => "ยินดีต้อนรับ ${name}";

  static String m75(year) => "${year} ปีที่แล้ว";

  static String m76(count) => "คุณกำลังเลือก ${count} รายการ";

  static String m77(total) => "คุณได้รับมอบหมายคำสั่งซื้อ #${total}";

  static String m78(type) => "คุณได้ผ่าน ${type}";

  static String m79(point) => "คุณมี \$point points";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("แบรนด์ราคาพิเศษ"),
