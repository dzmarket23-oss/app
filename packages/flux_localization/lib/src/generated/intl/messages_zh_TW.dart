...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m22(timeLeft) => "結束於 ${timeLeft}";

  static String m23(captcha) => "輸入${captcha}以確認：";

  static String m24(message) => "錯誤：${message}";

  static String m25(message) => "錯誤：${message}";

  static String m26(error) => "發生錯誤：${error}";

  static String m27(error) => "發生錯誤：${error}";

  static String m28(time) => "將於 ${time} 到期";

  static String m29(total) => ">${total} 公里";

  static String m30(hour) => "${hour} 小時前";

  static String m31(currentBalance) => "您的錢包餘額僅剩${currentBalance}";

  static String m32(message) => "請求資料時應用程式發生問題，請聯絡管理員解決問題：${message}";

  static String m33(currency, amount) => "使用此付款方式的最高金額為${currency} ${amount}";

  static String m34(size) => "最大檔案大小：${size} MB";

  static String m35(name, formattedPrice) => "${name}： ${formattedPrice}";

  static String m36(currency, amount) => "使用此付款方式的最低金額為${currency} ${amount}";

  static String m37(count) => "至少需要 ${count} 個字元";

  static String m38(storeName, minOrderAmount) =>
      " ${storeName} 的最低訂單金額為 ${minOrderAmount}。請從該商店添加更多商品！";

  static String m39(amount) => "此優惠券要求最低購買金額為 ${amount}。";

  static String m40(value) => "最低交易次數： ${value}";

  static String m41(minute) => "${minute} 分鐘前";

  static String m42(month) => "${month} 個月前";

  static String m43(store) => "${store}的更多商品";

  static String m44(number) => "必須以${number}為一組購買";

  static String m45(itemCount) => "${itemCount} 個項目";

  static String m46(price) => "選項總計：${price}";

  static String m47(amount) => "支付${amount}";

  static String m48(name) => "${name}已成功加入購物車";

  static String m49(total) => "數量：${total}";

  static String m50(name) => "收到來自${name}的款項";

  static String m51(count) => "您想從心願清單中刪除 ${count} 件商品嗎？";

  static String m52(percent) => "特價 ${percent}%";

  static String m53(keyword) => "「${keyword}」的搜尋結果";

  static String m54(keyword, count) => "${keyword}（${count}項）";

  static String m55(keyword, count) => "${keyword}（${count}項）";

  static String m56(second) => "${second}秒前";

  static String m57(totalCartQuantity) => "購物車，${totalCartQuantity}件商品";

  static String m58(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m59(price) => "起價 ${price}";

  static String m60(fieldName) => "${fieldName}為必填欄位";

  static String m61(total) => "${total}項商品";

  static String m62(name) => "轉帳給${name}";

  static String m63(price) => "最高 ${price}";

  static String m64(amount) => "使用 ${amount} 積分";

  static String m65(maxPointDiscount, maxPriceDiscount) =>
      "使用最多${maxPointDiscount}點積分可獲得此訂單${maxPriceDiscount}的折扣！";

  static String m66(time) => "有效期限至： ${time}";

  static String m67(date) => "有效期至 ${date}";

  static String m68(number) => "版本 ${number}";

  static String m69(balance) => "錢包餘額：${balance}";

  static String m70(message) => "警告：${message}";

  static String m71(defaultCurrency) => "目前選擇的貨幣不適用於錢包功能，請改為${defaultCurrency}";

  static String m72(length) => "我們找到了${length}項商品";

  static String m73(week) => "第${week}週";

  static String m74(name) => "歡迎${name}";

  static String m75(year) => "${year}年前";

  static String m76(count) => "您正在選擇 ${count} 項";

  static String m77(total) => "您已指派至訂單#${total}";

  static String m78(type) => "您已通過 ${type}";

  static String m79(point) => "您有${point}點積分";
