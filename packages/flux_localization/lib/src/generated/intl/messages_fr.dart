...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "La devise ${currency} n\'est pas prise en charge par votre compte Razorpay. Veuillez contacter le support pour activer les paiements internationaux ou changer pour une devise prise en charge.";

  static String m20(day) => "Il y a ${day} jours";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Se termine dans ${timeLeft}";

  static String m23(captcha) => "Saisissez ${captcha} pour confirmer :";

  static String m24(message) => "Erreur : ${message}";

  static String m25(message) => "Erreur : ${message}";

  static String m26(error) => "Une erreur est survenue : ${error}";

  static String m27(error) => "Une erreur est survenue : ${error}";

  static String m28(time) => "Expire dans ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "Il y a ${hour} heures";
  ...
  static String m34(size) => "Taille maximale du fichier : ${size} Mo";
  ...
  static String m37(count) => "Au moins ${count} caractères requis";
  ...
  static String m40(value) => "Transaction minimale : ${value}";

  static String m41(minute) => "Il y a ${minute} minutes";

  static String m42(month) => "Il y a ${month} mois";

  static String m43(store) => "Plus de ${store}";

  static String m44(number) => "Doit être acheté par groupes de ${number}";

  static String m45(itemCount) => "${itemCount} articles";

  static String m46(price) => "Total des options : ${price}";

  static String m47(amount) => "Payer ${amount}";

  static String m48(name) => "${name} a été ajouté au panier avec succès";

  static String m49(total) => "Qté : ${total}";

  static String m50(name) => "Reçu de l\'argent de ${name}";

  static String m51(count) =>
      "Voulez-vous retirer ${count} article(s) de votre liste de souhaits ?";

  static String m52(percent) => "Remise ${percent}%";

  static String m53(keyword) => "Résultats de recherche pour : \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} article)";

  static String m55(keyword, count) => "${keyword} (${count} articles)";

  static String m56(second) => "Il y a ${second} secondes";

  static String m57(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} articles";

  static String m58(numberOfUnitsSold) => "Vendu : ${numberOfUnitsSold}";

  static String m59(price) => "À partir de ${price}";

  static String m60(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m61(total) => "${total} produits";

  static String m62(name) => "Transférer de l\'argent à ${name}";

  static String m63(price) => "Jusqu\'à ${price}";

  static String m64(amount) => "Utilisez ${amount} points";
  ...
  static String m66(time) => "Valable jusqu\'au : ${time}";

  static String m67(date) => "Valable jusqu\'au ${date}";

  static String m68(number) => "Version ${number}";

  static String m69(balance) => "Solde du portefeuille : ${balance}";

  static String m70(message) => "Attention : ${message}";
  ...
  static String m72(length) => "Nous avons trouvé ${length} produits";

  static String m73(week) => "Semaine ${week}";

  static String m74(name) => "Bienvenue ${name}";

  static String m75(year) => "Il y a ${year} ans";

  static String m76(count) => "Vous sélectionnez ${count} article(s)";

  static String m77(total) => "Vous avez été assigné à la commande n°${total}";

  static String m78(type) => "Vous avez réussi ${type}";

  static String m79(point) => "Vous avez ${point} points";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Changer régulièrement votre mot de passe aide à protéger votre compte",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Êtes-vous sûr de vouloir terminer ce chat ?",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Impossible de créer une facture pour Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Impossible de créer une commande pour Razorpay",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Mettre à jour le mot de passe de sécurité",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Le chat a été terminé. Veuillez démarrer un nouveau chat.",
    ),
    ...
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Par défaut"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Le nom d’affichage est généré automatiquement à partir du prénom et du nom",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Modifier l\'adresse"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Terminer le chat"),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Oups ! Nous n’avons pas pu ouvrir ce lien.",
    ),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Chat en direct"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Pas d\'internet. Reconnectez-vous pour continuer vos achats.",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Aucune information sur le magasin disponible",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Vous n\'êtes pas connecté, le chat expirera si vous quittez.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Adresse d\'origine introuvable",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Autre adresse"),
    ...
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Mettre à jour le nom, le numéro de téléphone",
    ),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "Choisissez votre destination de livraison.",
    ),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Veuillez d\'abord ajouter une adresse",
    ),
    ...
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Veuillez vérifier les problèmes suivants :",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produit non prêt pour une nouvelle commande",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Variations du produit non disponibles",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Régions"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Pertinence"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Dates de location"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Votre commande a été reçue dans le système et vous pouvez envoyer la même commande via WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Membre Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Doit contenir des chiffres et des caractères spéciaux",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Démarrer le chat"),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Utilisez les codes d\'État à 2 lettres (CA, NY, TX)\n• Utilisez les codes pays à 2 lettres (US, CA, GB)\n• Vérifiez le format du code postal\n• Assurez-vous que tous les champs obligatoires sont remplis",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Vous devez vous connecter pour voir les adresses",
    ),
