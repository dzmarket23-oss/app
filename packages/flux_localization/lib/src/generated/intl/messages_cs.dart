...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(day) => "Před ${day} dny";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Končí za ${timeLeft}";

  static String m23(captcha) => "Pro potvrzení zadejte ${captcha}:";

  static String m24(message) => "Chyba: ${message}";

  static String m25(message) => "Chyba: ${message}";

  static String m26(error) => "Došlo k chybě: ${error}";

  static String m27(error) => "Došlo k chybě: ${error}";

  static String m28(time) => "Končí za ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "Před ${hour} hodinami";
  ...
  static String m34(size) => "Maximální velikost souboru: ${size} MB";
  ...
  static String m37(count) => "Je vyžadováno minimálně ${count} znaků";
  ...
  static String m40(value) => "Minimální transakce: ${value}";

  static String m41(minute) => "Před ${minute} minutami";

  static String m42(month) => "Před ${month} měsíci";

  static String m43(store) => "Další od ${store}";

  static String m44(number) => "Musí být zakoupeno v množství po ${number}";

  static String m45(itemCount) => "Položky: ${itemCount}";

  static String m46(price) => "Celkem možností: ${price}";

  static String m47(amount) => "Zaplatit ${amount}";

  static String m48(name) => "Produkt ${name} byl přidán do košíku";

  static String m49(total) => "Množství: ${total}";

  static String m50(name) => "Přijaty peníze od uživatele ${name}";

  static String m51(count) =>
      "Chcete odebrat položky (celkem ${count}) ze seznamu přání?";

  static String m52(percent) => "Sleva ${percent}%";

  static String m53(keyword) => "Výsledky hledání pro \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} položka)";

  static String m55(keyword, count) => "${keyword} (${count} položek)";

  static String m56(second) => "Před ${second} sekundami";

  static String m57(totalCartQuantity) =>
      "Nákupní košík, ${totalCartQuantity} položek";

  static String m58(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m59(price) => "Začíná od ${price}";

  static String m60(fieldName) => "Pole ${fieldName} je povinné";

  static String m61(total) => "${total} produktů";

  static String m62(name) => "Převést peníze uživateli ${name}";

  static String m63(price) => "Až do ${price}";

  static String m64(amount) => "Použijte ${amount} bodů";
  ...
  static String m68(number) => "Verze ${number}";

  static String m69(balance) => "Zůstatek v peněžence: ${balance}";

  static String m70(message) => "Upozornění: ${message}";
  ...
  static String m72(length) => "Našli jsme ${length} produktů";

  static String m73(week) => "Týden ${week}";

  static String m74(name) => "Vítejte, ${name}";

  static String m75(year) => "Před ${year} lety";

  static String m76(count) => "Vybíráte položky (celkem ${count})";

  static String m77(total) => "Přiřadili jste objednávku č. ${total}";

  static String m78(type) => "Splnili jste ${type}";

  static String m79(point) => "Máte ${point} bodů";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Značky za méně"),
