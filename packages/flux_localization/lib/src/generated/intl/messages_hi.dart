...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "मुद्रा ${currency} आपके Razorpay खाते द्वारा समर्थित नहीं है। कृपया अंतरराष्ट्रीय भुगतान सक्षम करने के लिए सपोर्ट से संपर्क करें या समर्थित मुद्रा में बदलें।";

  static String m20(day) => "${day} दिन पहले";

  static String m21(total) => "~${total} किमी";

  static String m22(timeLeft) => "${timeLeft} में समाप्त होता है";

  static String m23(captcha) => "पुष्टि के लिए ${captcha} दर्ज करें:";

  static String m24(message) => "त्रुटि: ${message}";

  static String m25(message) => "त्रुटि: ${message}";

  static String m26(error) => "एक त्रुटि हुई: ${error}";

  static String m27(error) => "एक त्रुटि हुई: ${error}";

  static String m28(time) => "${time} में समाप्त हो रहा है";

  static String m29(total) => ">${total} किमी";

  static String m30(hour) => "${hour} घंटे पहले";
  ...
  static String m34(size) => "अधिकतम फ़ाइल आकार: ${size} MB";
  ...
  static String m37(count) => "कम से कम ${count} अक्षर आवश्यक हैं";
  ...
  static String m40(value) => "न्यूनतम लेनदेन: ${value}";

  static String m41(minute) => "${minute} मिनट पहले";

  static String m42(month) => "${month} महीने पहले";

  static String m43(store) => "${store} से और";

  static String m44(number) => "${number} के समूह में खरीदा जाना चाहिए";

  static String m45(itemCount) => "${itemCount} आइटम";

  static String m46(price) => "विकल्पों का कुल: ${price}";

  static String m47(amount) => "${amount} का भुगतान करें";

  static String m48(name) => "${name} सफलतापूर्वक कार्ट में जोड़ा गया";

  static String m49(total) => "मात्रा: ${total}";

  static String m50(name) => "${name} से पैसे प्राप्त हुए";

  static String m51(count) =>
      "क्या आप अपनी इच्छा-सूची से ${count} वस्तु हटाना चाहते हैं?";

  static String m52(percent) => "बिक्री ${percent}%";

  static String m53(keyword) => "\'${keyword}\' के लिए खोज परिणाम";

  static String m54(keyword, count) => "${keyword} (${count} आइटम)";

  static String m55(keyword, count) => "${keyword} (${count} आइटम)";

  static String m56(second) => "${second} सेकंड पहले";

  static String m57(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m58(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m59(price) => "${price} से शुरू";

  static String m60(fieldName) => "${fieldName} फ़ील्ड आवश्यक है";

  static String m61(total) => "कुल उत्पाद: ${total}";

  static String m62(name) => "${name} को पैसे भेजें";

  static String m63(price) => "अधिकतम ${price} तक";

  static String m64(amount) => " ${amount} अंक का उपयोग करें";
  ...
  static String m66(time) => " ${time}तक वैध";

  static String m67(date) => "${date} तक मान्य";

  static String m68(number) => "संस्करण ${number}";

  static String m69(balance) => "वॉलेट में शेष: ${balance}";

  static String m70(message) => "चेतावनी: ${message}";
  ...
  static String m72(length) => "हमें ${length} उत्पाद मिले";

  static String m73(week) => "सप्ताह ${week}";

  static String m74(name) => "स्वागत है ${name}";

  static String m75(year) => "${year} साल पहले";

  static String m76(count) => "आप ${count} वस्तु चुन रहे हैं";

  static String m77(total) => "आपको ऑर्डर #${total} असाइन किया गया है";

  static String m78(type) => "आप ${type}पार कर चुके हैं";

  static String m79(point) => "आपके पास ${point} अंक हैं";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("खाता सुरक्षा"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "नियमित रूप से अपना पासवर्ड बदलना आपके खाते की सुरक्षा करता है",
    ),
    ...
    "addressManagement": MessageLookupByLibrary.simpleMessage("पता प्रबंधन"),
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "शिपिंग पते जोड़ें, संपादित करें",
    ),
    "addressNotFound": MessageLookupByLibrary.simpleMessage("पता नहीं मिला"),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "क्या आप वाकई इस चैट को समाप्त करना चाहते हैं?",
    ),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("ब्रांड्स फॉर लेस"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "पासवर्ड नहीं बदल सकता। कृपया पुनः प्रयास करें।",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Razorpay के लिए इनवॉइस नहीं बना सकते",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Razorpay के लिए ऑर्डर नहीं बना सकते",
    ),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("डिफॉल्ट पता"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "डिफॉल्ट पता सफलतापूर्वक अपडेट किया गया",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("डिफॉल्ट"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "डिस्प्ले नाम स्वतः पहले और अंतिम नाम से बनाया जाता है",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("पता संपादित करें"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("चैट समाप्त करें"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("त्रुटि"),
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "क्या आपके पास कोई सवाल है? हमें लिखें!",
    ),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("लाइव चैट"),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("नाम आवश्यक है"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("नया पासवर्ड"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ कोई इंटरनेट नहीं। खरीदारी जारी रखने के लिए पुनः कनेक्ट करें।",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "इस ऑर्डर में कोई उत्पाद नहीं मिला",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "कोई स्टोर जानकारी उपलब्ध नहीं है",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "आप लॉग इन नहीं हैं, यदि आप बाहर निकलते हैं तो चैट समाप्त हो जाएगी।",
    ),
    ...
    "otherAddress": MessageLookupByLibrary.simpleMessage("अन्य पता"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("पासवर्ड सुझाव:"),
    ...
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "कृपया निम्नलिखित समस्याओं की जांच करें:",
    ),
    ...
    "pressBackButtonAgainToExit": MessageLookupByLibrary.simpleMessage(
      "बाहर निकलने के लिए फिर से दबाएँ",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "पुनः ऑर्डर के लिए उत्पाद तैयार नहीं है",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "उत्पाद विविधताएँ उपलब्ध नहीं हैं",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("क्षेत्र"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("प्रासंगिकता"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("किराये की तिथियाँ"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("सहेजे गए पते"),
    "savedToGallery": MessageLookupByLibrary.simpleMessage(
      "गैलरी में सेव किया गया",
    ),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("देश खोजें..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "WhatsApp के माध्यम से ऑर्डर भेजें",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "आपका ऑर्डर सिस्टम में प्राप्त हो गया है और आप वही ऑर्डर WhatsApp के माध्यम से भेज सकते हैं।",
    ),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• संख्याएँ और विशेष वर्ण शामिल होने चाहिए",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• बड़े और छोटे अक्षर शामिल होने चाहिए",
    ),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("सुझाव:"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("पता अपडेट करें"),
    ...
    "updateInformationSuccess": MessageLookupByLibrary.simpleMessage(
      "जानकारी सफलतापूर्वक अपडेट हो गई",
    ),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• 2-अक्षर राज्य कोड का उपयोग करें (CA, NY, TX)\n• 2-अक्षर देश कोड का उपयोग करें (US, CA, GB)\n• ZIP/पोस्टल कोड प्रारूप जांचें\n• सुनिश्चित करें कि सभी आवश्यक फ़ील्ड भरे गए हैं",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "पते देखने के लिए आपको लॉगिन करना होगा",
    ),
