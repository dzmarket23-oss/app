...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "La valuta ${currency} non è supportata dal tuo account Razorpay. Contatta l\'assistenza per abilitare i pagamenti internazionali o cambia con una valuta supportata.";

  static String m20(day) => "${day} giorni fa";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Termina tra ${timeLeft}";

  static String m23(captcha) => "Inserisci ${captcha} per confermare:";

  static String m24(message) => "Errore: ${message}";

  static String m25(message) => "Errore: ${message}";

  static String m26(error) => "Si è verificato un errore: ${error}";

  static String m27(error) => "Si è verificato un errore: ${error}";

  static String m28(time) => "Scade tra ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} ore fa";
  ...
  static String m34(size) => "Dimensione massima file: ${size} MB";
  ...
  static String m37(count) => "Sono richiesti almeno ${count} caratteri";
  ...
  static String m40(value) => "Transazione minima: ${value}";

  static String m41(minute) => "${minute} minuti fa";

  static String m42(month) => "${month} mesi fa";

  static String m43(store) => "Altri prodotti da ${store}";

  static String m44(number) => "Deve essere acquistato in gruppi di ${number}";

  static String m45(itemCount) => "${itemCount} articoli";

  static String m46(price) => "Totale opzioni: ${price}";

  static String m47(amount) => "Paga ${amount}";

  static String m48(name) => "${name} aggiunto al carrello";

  static String m49(total) => "Qtà: ${total}";

  static String m50(name) => "Ricevuto denaro da ${name}";

  static String m51(count) => "Vuoi rimuovere ${count} articoli dai preferiti?";

  static String m52(percent) => "Sconto ${percent}%";

  static String m53(keyword) => "Risultati per: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} risultato)";

  static String m55(keyword, count) => "${keyword} (${count} risultati)";

  static String m56(second) => "${second} secondi fa";

  static String m57(totalCartQuantity) =>
      "Carrello, ${totalCartQuantity} articoli";

  static String m58(numberOfUnitsSold) => "Venduto: ${numberOfUnitsSold}";

  static String m59(price) => "A partire da ${price}";

  static String m60(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m61(total) => "${total} prodotti";

  static String m62(name) => "Trasferisci denaro a ${name}";

  static String m63(price) => "Fino a ${price}";

  static String m64(amount) => "Usa ${amount} punti";
  ...
  static String m66(time) => "Valido fino al: ${time}";

  static String m67(date) => "Valido fino al ${date}";

  static String m68(number) => "Versione ${number}";

  static String m69(balance) => "Saldo portafoglio: ${balance}";

  static String m70(message) => "Attenzione: ${message}";
  ...
  static String m72(length) => "Abbiamo trovato ${length} prodotti";

  static String m73(week) => "Settimana ${week}";

  static String m74(name) => "Benvenuto ${name}";

  static String m75(year) => "${year} anni fa";

  static String m76(count) => "Stai selezionando ${count} articoli";

  static String m77(total) => "Hai assegnato l\'ordine n. ${total}";

  static String m78(type) => "Hai superato ${type}";

  static String m79(point) => "Hai ${point} punti";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Cambiare regolarmente la password aiuta a proteggere il tuo account",
    ),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Aggiungi, modifica indirizzi di spedizione",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Sei sicuro di voler terminare questa chat?",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Impossibile creare la fattura per Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Impossibile creare l’ordine per Razorpay",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Aggiorna password di sicurezza",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "La chat è stata terminata. Avvia una nuova chat.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage(
      "Schermata Lista Chat",
    ),
    "chatNow": MessageLookupByLibrary.simpleMessage("Chatta ora"),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("paesi"),
    ...
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Indirizzo predefinito aggiornato con successo",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Predefinito"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Il nome visualizzato viene generato automaticamente da nome e cognome",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Modifica indirizzo"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Termina chat"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Inserisci le informazioni dell\'indirizzo",
    ),
    "enterYourCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "Inserisci la tua posizione attuale",
    ),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Errore"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Impossibile aggiornare l\'indirizzo predefinito",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ops! Non siamo riusciti ad aprire questo link.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("è richiesto"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Chat dal vivo"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Nessuna connessione internet. Riconnettiti per continuare lo shopping.",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Nessuna informazione sul negozio disponibile",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Non hai effettuato l\'accesso, la chat scadrà se esci.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Indirizzo originale non trovato",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Altro indirizzo"),
    ...
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Aggiorna nome, numero di telefono",
    ),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "Scegli la tua destinazione di spedizione.",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Prodotto non pronto per il riordino",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Varianti del prodotto non disponibili",
    ),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Rilevanza"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Date di noleggio"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Indirizzi salvati"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Cerca paesi..."),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Il tuo ordine è stato ricevuto nel sistema e puoi inviare lo stesso ordine tramite WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Membro Shopify"),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Avvia chat"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Suggerimenti:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Marchi principali"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Tipi"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Non definito"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Aggiorna indirizzo"),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Usa codici stato a 2 lettere (CA, NY, TX)\n• Usa codici paese a 2 lettere (US, CA, GB)\n• Controlla il formato del CAP/codice postale\n• Assicurati che tutti i campi obbligatori siano compilati",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Devi accedere per vedere gli indirizzi",
    ),
