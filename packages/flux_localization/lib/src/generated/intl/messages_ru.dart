...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Валюта ${currency} не поддерживается вашим аккаунтом Razorpay. Пожалуйста, обратитесь в поддержку для включения международных платежей или выберите поддерживаемую валюту.";

  static String m20(day) => "${day} дней назад";

  static String m21(total) => "~${total} км";

  static String m22(timeLeft) => "Заканчивается через ${timeLeft}";

  static String m23(captcha) => "Введите ${captcha} для подтверждения:";

  static String m24(message) => "Ошибка: ${message}";

  static String m25(message) => "Ошибка: ${message}";

  static String m26(error) => "Произошла ошибка: ${error}";

  static String m27(error) => "Произошла ошибка: ${error}";

  static String m28(time) => "Истекает через ${time}";

  static String m29(total) => ">${total} км";

  static String m30(hour) => "${hour} часов назад";
  ...
  static String m34(size) => "Максимальный размер файла: ${size} МБ";
  ...
  static String m37(count) => "Требуется минимум ${count} символов";
  ...
  static String m40(value) => "Минимальная транзакция: ${value}";

  static String m41(minute) => "${minute} минут назад";

  static String m42(month) => "${month} месяцев назад";

  static String m43(store) => "Еще из ${store}";

  static String m44(number) => "Необходимо покупать группами по ${number}";

  static String m45(itemCount) => "${itemCount} товаров";

  static String m46(price) => "Всего опций: ${price}";

  static String m47(amount) => "Оплатить ${amount}";

  static String m48(name) => "Товар ${name} добавлен в корзину";

  static String m49(total) => "Кол-во: ${total}";

  static String m50(name) => "Получены деньги от ${name}";

  static String m51(count) => "Удалить ${count} товар(ов) из списка желаний?";

  static String m52(percent) => "Скидка ${percent}%";

  static String m53(keyword) => "Результаты поиска для \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} товар)";

  static String m55(keyword, count) => "${keyword} (${count} товаров)";

  static String m56(second) => "${second} секунд назад";
  ...
  static String m59(price) => "От ${price}";

  static String m60(fieldName) =>
      "Поле ${fieldName} обязательно для заполнения";

  static String m61(total) => "${total} товаров";

  static String m62(name) => "Перевести деньги пользователю ${name}";

  static String m63(price) => "До ${price}";

  static String m64(amount) => "Используйте ${amount} баллов";
  ...
  static String m66(time) => "Действительно до: ${time}";

  static String m67(date) => "Действительно до ${date}";

  static String m68(number) => "Версия ${number}";

  static String m69(balance) => "Баланс кошелька: ${balance}";
  ...
  static String m72(length) => "Мы нашли товары";

  static String m73(week) => "Неделя ${week}";

  static String m74(name) => "Добро пожаловать, ${name}";

  static String m75(year) => "${year} лет назад";

  static String m76(count) => "Вы выбираете ${count} товар(ов)";

  static String m77(total) => "Вам назначен заказ №${total}";

  static String m78(type) => "Вы прошли ${type}";

  static String m79(point) => "У вас есть ${point} баллов";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Регулярная смена пароля помогает защитить ваш аккаунт",
    ),
    ...
    "addressNotFound": MessageLookupByLibrary.simpleMessage("Адрес не найден"),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Вы уверены, что хотите завершить этот чат?",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Не удалось изменить пароль. Пожалуйста, попробуйте ещё раз.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Невозможно создать счет для Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Невозможно создать заказ для Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Чат завершен. Пожалуйста, начните новый чат.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Список чатов"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Чат сейчас"),
    ...
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Адрес по умолчанию успешно обновлён",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("По умолчанию"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Отображаемое имя создаётся автоматически из имени и фамилии",
    ),
    "distance": m21,
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Завершить чат"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Введите информацию об адресе",
    ),
    "enterYourCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "Введите ваше текущее местоположение",
    ),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Не удалось обновить адрес по умолчанию",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Упс! Не удалось открыть эту ссылку.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("требуется"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Новый пароль"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Нет интернета. Подключитесь, чтобы продолжить покупки.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "В этом заказе не найдено товаров",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Информация о магазине недоступна",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Вы не вошли в систему, чат будет завершен при выходе.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Оригинальный адрес не найден",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Другой адрес"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Советы по паролю:"),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Пожалуйста, сначала добавьте адрес",
    ),
    ...
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Пожалуйста, проверьте следующие проблемы:",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Товар не готов к повторному заказу",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Регионы"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Актуальность"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Даты аренды"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Поиск стран..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Отправить заказ через WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Ваш заказ получен системой, и вы можете отправить тот же заказ через WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Участник Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Должен содержать цифры и специальные символы",
    ),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Топ бренды"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Типы"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Не определено"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Обновить адрес"),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("Ошибка проверки"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Используйте 2-буквенные коды штатов (CA, NY, TX)\n• Используйте 2-буквенные коды стран (US, CA, GB)\n• Проверьте формат ZIP/почтового кода\n• Убедитесь, что все обязательные поля заполнены",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Войдите в систему, чтобы увидеть адреса",
    ),
