...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "العملة ${currency} غير مدعومة في حساب Razorpay الخاص بك. يرجى التواصل مع الدعم لتفعيل المدفوعات الدولية أو تغيير العملة إلى عملة مدعومة.";

  static String m20(day) => "قبل ${day} يوم";

  static String m21(total) => "~${total} كم";

  static String m22(timeLeft) => "ينتهي في ${timeLeft}";

  static String m23(captcha) => "أدخل ${captcha} للتأكيد:";

  static String m24(message) => "خطأ: ${message}";

  static String m25(message) => "خطأ: ${message}";

  static String m26(error) => "حدث خطأ: ${error}";

  static String m27(error) => "حدث خطأ: ${error}";

  static String m28(time) => "تنتهي الصلاحية في ${time}";

  static String m29(total) => "أكثر من ${total} كم";

  static String m30(hour) => "قبل ${hour} ساعة";

  static String m31(currentBalance) => "لديك فقط ${currentBalance} في محفظتك";
  ...
  static String m34(size) => "الحد الأقصى لحجم الملف: ${size} ميجابايت";
  ...
  static String m37(count) => "مطلوب على الأقل ${count} أحرف";
  ...
  static String m40(value) => "الحد الأدنى للمعاملة: ${value}";

  static String m41(minute) => "قبل ${minute} دقيقة";

  static String m42(month) => "منذ ${month} شهر";

  static String m43(store) => "المزيد من ${store}";

  static String m44(number) => "يجب الشراء بمجموعات من ${number}";

  static String m45(itemCount) => "${itemCount} عنصر";

  static String m46(price) => "إجمالي الخيارات: ${price}";

  static String m47(amount) => "ادفع ${amount}";

  static String m48(name) => "تمت إضافة ${name} إلى السلة بنجاح";

  static String m49(total) => "الكمية: ${total}";

  static String m50(name) => "استلمت مبلغاً من ${name}";

  static String m51(count) => "هل تريد إزالة ${count} عنصر من قائمة رغباتك؟";

  static String m52(percent) => "خصم ${percent}٪";

  static String m53(keyword) => "نتائج البحث عن: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} عنصر)";

  static String m55(keyword, count) => "${keyword} (${count} عنصر)";

  static String m56(second) => "قبل ${second} ثانية";

  static String m57(totalCartQuantity) =>
      "سلة التسوق، ${totalCartQuantity} عنصر";

  static String m58(numberOfUnitsSold) => "تم البيع: ${numberOfUnitsSold}";

  static String m59(price) => "يبدأ من ${price}";

  static String m60(fieldName) => "حقل ${fieldName} مطلوب";

  static String m61(total) => "${total} منتج";

  static String m62(name) => "تحويل مبلغ إلى ${name}";

  static String m63(price) => "حتى ${price}";

  static String m64(amount) => "استخدم ${amount} نقطة";
  ...
  static String m66(time) => "صالحة حتى: ${time}";

  static String m67(date) => "صالح حتى ${date}";

  static String m68(number) => "الإصدار ${number}";

  static String m69(balance) => "رصيد المحفظة: ${balance}";

  static String m70(message) => "تحذير: ${message}";

  static String m71(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m72(length) => "تم العثور على ${length} منتج";

  static String m73(week) => "الأسبوع ${week}";

  static String m74(name) => "مرحباً ${name}";

  static String m75(year) => "منذ ${year} سنة";

  static String m76(count) => "أنت تختار ${count} عنصر";

  static String m77(total) => "تم تعيينك للطلب رقم ${total}";

  static String m78(type) => "لقد اجتزت ${type}";

  static String m79(point) => "لديك ${point} نقطة";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "تغيير كلمة المرور بانتظام يساعد في حماية حسابك",
    ),
    ...
    "addressManagement": MessageLookupByLibrary.simpleMessage("إدارة العناوين"),
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "إضافة وتعديل عناوين الشحن",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "هل أنت متأكد أنك تريد إنهاء هذه الدردشة؟",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "لا يمكن تغيير كلمة المرور. يرجى المحاولة مرة أخرى.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "لا يمكن إنشاء فاتورة لـ Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "لا يمكن إنشاء طلب لـ Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "تم إنهاء الدردشة. يرجى بدء دردشة جديدة.",
    ),
    ...
    "countProduct": m15,
    "countProducts": m16,
    "countries": MessageLookupByLibrary.simpleMessage("دولة"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "يتم إنشاء الاسم المعروض تلقائياً من الاسم الأول والأخير",
    ),
    "distance": m21,
    ...
    "failedToSaveImage": MessageLookupByLibrary.simpleMessage("فشل حفظ الصورة"),
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "فشل في تحديث العنوان الافتراضي",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "عذراً! لم نتمكن من فتح هذا الرابط.",
    ),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("لا يوجد اسم معروض"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ لا يوجد اتصال بالإنترنت. أعد الاتصال لمتابعة التسوق.",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "أنت غير مسجل الدخول، ستنتهي الدردشة إذا خرجت.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "العنوان الأصلي غير موجود",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("عنوان آخر"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("نصائح كلمة المرور:"),
    ...
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "يرجى التحقق من المشاكل التالية:",
    ),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("الصلة"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("تواريخ الإيجار"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "تم استلام طلبك في النظام ويمكنك إرسال نفس الطلب عبر واتساب.",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("ابدأ الدردشة"),
    ...
    "validUntil": m66,
    "validUntilDate": m67,
    "validationError": MessageLookupByLibrary.simpleMessage("خطأ في التحقق"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• استخدم رموز الولاية المكونة من حرفين (CA, NY, TX)\n• استخدم رموز البلد المكونة من حرفين (US, CA, GB)\n• تحقق من تنسيق الرمز البريدي\n• تأكد من ملء جميع الحقول المطلوبة",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "يجب عليك تسجيل الدخول لرؤية العناوين",
    ),
