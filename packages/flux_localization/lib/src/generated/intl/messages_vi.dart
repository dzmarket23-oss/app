...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "Đơn vị tiền tệ ${currency} không được tài khoản Razorpay của bạn hỗ trợ. Vui lòng liên hệ hỗ trợ để bật thanh toán quốc tế hoặc đổi sang đơn vị tiền tệ được hỗ trợ.";

  static String m20(day) => "${day} ngày trước";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Kết thúc sau ${timeLeft}";

  static String m23(captcha) => "Nhập ${captcha} để xác nhận:";

  static String m24(message) => "Lỗi: ${message}";

  static String m25(message) => "Lỗi: ${message}";

  static String m26(error) => "Có lỗi xảy ra: ${error}";

  static String m27(error) => "Có lỗi xảy ra: ${error}";

  static String m28(time) => "Hết hạn sau ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} giờ trước";
  ...
  static String m34(size) => "Kích thước tệp tối đa: ${size} MB";
  ...
  static String m37(count) => "Yêu cầu tối thiểu ${count} ký tự";
  ...
  static String m40(value) => "Giao dịch tối thiểu: ${value}";

  static String m41(minute) => "${minute} phút trước";

  static String m42(month) => "${month} tháng trước";

  static String m43(store) => "Thêm từ ${store}";

  static String m44(number) => "phải mua theo nhóm ${number}";

  static String m45(itemCount) => "${itemCount} sản phẩm";

  static String m46(price) => "Tổng số tùy chọn: ${price}";

  static String m47(amount) => "Thanh toán ${amount}";

  static String m48(name) => "${name} đã được thêm vào giỏ hàng thành công";

  static String m49(total) => "SL: ${total}";

  static String m50(name) => "Nhận tiền từ ${name}";

  static String m51(count) =>
      "Bạn có muốn xóa ${count} sản phẩm khỏi danh sách mong muốn của mình không?";

  static String m52(percent) => "Giảm ${percent}%";

  static String m53(keyword) => "Kết quả tìm kiếm cho: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} mục)";

  static String m55(keyword, count) => "${keyword} (${count} mục)";

  static String m56(second) => "${second} giây trước";

  static String m57(totalCartQuantity) =>
      "Giỏ hàng, ${totalCartQuantity} sản phẩm";

  static String m58(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m59(price) => "Bắt đầu từ ${price}";

  static String m60(fieldName) => "Trường ${fieldName} là bắt buộc";

  static String m61(total) => "${total} sản phẩm";

  static String m62(name) => "Chuyển tiền đến ${name}";

  static String m63(price) => "Tối đa ${price}";

  static String m64(amount) => "Sử dụng ${amount} điểm";
  ...
  static String m66(time) => "Có hiệu lực đến: ${time}";

  static String m67(date) => "Có giá trị đến ${date}";

  static String m68(number) => "Phiên bản ${number}";

  static String m69(balance) => "Số dư ví: ${balance}";

  static String m70(message) => "Cảnh báo: ${message}";
  ...
  static String m72(length) => "Tìm thấy ${length} sản phẩm";

  static String m73(week) => "Tuần ${week}";

  static String m74(name) => "Chào mừng ${name}";

  static String m75(year) => "${year} năm trước";

  static String m76(count) => "Bạn đang chọn ${count} mục";

  static String m77(total) => "Bạn đã được phân công đơn hàng #${total}";

  static String m78(type) => "Bạn đã vượt qua ${type}";

  static String m79(point) => "Bạn có ${point} điểm";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Thay đổi mật khẩu định kỳ giúp bảo vệ tài khoản của bạn",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Bạn có chắc muốn kết thúc cuộc trò chuyện này không?",
    ),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Thương hiệu giá rẻ"),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Không thể tạo hóa đơn cho Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Không thể tạo đơn hàng cho Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Trò chuyện đã kết thúc. Vui lòng bắt đầu cuộc trò chuyện mới.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage(
      "Danh sách trò chuyện",
    ),
    "chatNow": MessageLookupByLibrary.simpleMessage("Trò chuyện ngay"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Địa chỉ mặc định"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Cập nhật địa chỉ mặc định thành công",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Mặc định"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Tên hiển thị được tạo tự động từ tên và họ",
    ),
    "distance": m21,
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Bạn có câu hỏi nào không? Hãy viết cho chúng tôi!",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ôi! Chúng tôi không thể mở liên kết này.",
    ),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Trò chuyện trực tiếp"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Mật khẩu mới"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Không có kết nối internet. Kết nối lại để tiếp tục mua sắm.",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Bạn chưa đăng nhập, trò chuyện sẽ hết hạn nếu bạn thoát.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Không tìm thấy địa chỉ gốc",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Địa chỉ khác"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Gợi ý mật khẩu:"),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Vui lòng cho phép truy cập vào vị trí",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Sản phẩm chưa sẵn sàng để đặt lại",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Khu vực"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Liên quan"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Ngày thuê"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Địa chỉ đã lưu"),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Gửi đơn hàng qua WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Đơn hàng của bạn đã được nhận trong hệ thống và bạn có thể gửi cùng đơn hàng này qua WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Thành viên Shopify"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Mẹo:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Thương hiệu hàng đầu"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Loại"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Cập nhật địa chỉ"),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Sử dụng mã tiểu bang gồm 2 chữ cái (CA, NY, TX)\n• Sử dụng mã quốc gia gồm 2 chữ cái (US, CA, GB)\n• Kiểm tra định dạng mã ZIP/mã bưu chính\n• Đảm bảo tất cả các trường bắt buộc đã được điền",
    ),
