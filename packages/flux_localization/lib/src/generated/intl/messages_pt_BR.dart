...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currency) =>
      "A moeda ${currency} não é suportada pela sua conta Razorpay. Por favor, entre em contato com o suporte para habilitar pagamentos internacionais ou altere para uma moeda suportada.";

  static String m20(day) => "há ${day} dias";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Termina em ${timeLeft}";

  static String m23(captcha) => "Digite ${captcha} para confirmar:";

  static String m24(message) => "Erro: ${message}";

  static String m25(message) => "Erro: ${message}";

  static String m26(error) => "Ocorreu um erro: ${error}";

  static String m27(error) => "Ocorreu um erro: ${error}";

  static String m28(time) => "Expira em ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "há ${hour} horas";
  ...
  static String m34(size) => "Tamanho máximo do arquivo: ${size} MB";
  ...
  static String m37(count) => "É necessário no mínimo ${count} caracteres";
  ...
  static String m41(minute) => "há ${minute} minutos";

  static String m42(month) => "Há ${month} meses";

  static String m43(store) => "Mais de ${store}";

  static String m44(number) => "Deve ser comprado em grupos de ${number}";

  static String m45(itemCount) => "${itemCount} itens";

  static String m46(price) => "Total de opções: ${price}";

  static String m47(amount) => "Pagar ${amount}";

  static String m48(name) => "${name} foi adicionado ao carrinho com sucesso";

  static String m49(total) => "Qtd: ${total}";

  static String m50(name) => "Recebeu dinheiro de ${name}";

  static String m51(count) =>
      "Deseja remover ${count} item(ns) da sua lista de desejos?";

  static String m52(percent) => "${percent}% de desconto";

  static String m53(keyword) => "Resultados da pesquisa para: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} item)";

  static String m55(keyword, count) => "${keyword} (${count} itens)";

  static String m56(second) => "há ${second} segundos";

  static String m57(totalCartQuantity) =>
      "Carrinho de compras, ${totalCartQuantity} itens";

  static String m58(numberOfUnitsSold) => "Vendido: ${numberOfUnitsSold}";

  static String m59(price) => "A partir de ${price}";

  static String m60(fieldName) => "O campo ${fieldName} é obrigatório";

  static String m61(total) => "${total} produtos";

  static String m62(name) => "Transferir dinheiro para ${name}";

  static String m63(price) => "Até ${price}";

  static String m64(amount) => "Usar ${amount} pontos";
  ...
  static String m67(date) => "Válido até ${date}";

  static String m68(number) => "Versão ${number}";

  static String m69(balance) => "Saldo da carteira: ${balance}";

  static String m70(message) => "Aviso: ${message}";
  ...
  static String m72(length) => "Encontramos ${length} produtos";

  static String m73(week) => "Semana ${week}";

  static String m74(name) => "Bem-vindo(a), ${name}";

  static String m75(year) => "${year} anos atrás";

  static String m76(count) => "Você está selecionando ${count} item(ns)";

  static String m77(total) => "Você foi atribuído ao pedido #${total}";
  ...
  static String m79(point) => "Você tem ${point} pontos";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Alterar sua senha regularmente ajuda a proteger sua conta",
    ),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Adicionar, editar endereços de entrega",
    ),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Tem certeza de que deseja encerrar este chat?",
    ),
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Marcas por Menos"),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Não foi possível criar fatura para Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Não é possível criar pedido para Razorpay",
    ),
    ...
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "O chat foi encerrado. Por favor, inicie um novo chat.",
    ),
    "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
    "chatListScreen": MessageLookupByLibrary.simpleMessage(
      "Lista de conversas",
    ),
    "chatNow": MessageLookupByLibrary.simpleMessage("Conversar agora"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Endereço Padrão"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Endereço padrão atualizado com sucesso",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Padrão"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "O nome de exibição é gerado automaticamente a partir do primeiro e do último nome",
    ),
    "distance": m21,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Editar Endereço"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Encerrar Chat"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Digite suas informações de endereço",
    ),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Erro"),
    ...
    "failedToUpdateDefaultAddress": MessageLookupByLibrary.simpleMessage(
      "Falha ao atualizar endereço padrão",
    ),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ops! Não foi possível abrir este link.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("é obrigatório"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Chat ao Vivo"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Nova Senha"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Sem internet. Reconecte para continuar comprando.",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Nenhuma informação da loja disponível",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Você não está logado, o chat expirará se você sair.",
    ),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Endereço original não encontrado",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Outro Endereço"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Dicas de senha:"),
    ...
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Atualizar nome, número de telefone",
    ),
    ...
    "pickShippingDestination": MessageLookupByLibrary.simpleMessage(
      "Escolha seu destino de entrega.",
    ),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Por favor, adicione um endereço primeiro",
    ),
    ...
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Por favor, verifique os seguintes problemas:",
    ),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produto não disponível para novo pedido",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Variações do produto não disponíveis",
    ),
    ...
    "regions": MessageLookupByLibrary.simpleMessage("Regiões"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Relevância"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Datas de locação"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Endereços Salvos"),
    "savedToGallery": MessageLookupByLibrary.simpleMessage("Salvo na galeria"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Buscar países..."),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Seu pedido foi recebido no sistema e você pode enviar o mesmo pedido pelo WhatsApp.",
    ),
    ...
    "setAsDefault": MessageLookupByLibrary.simpleMessage("Definir como Padrão"),
    ...
    "shopifyAccountManagement": MessageLookupByLibrary.simpleMessage(
      "Gerenciamento de Conta Shopify",
    ),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Deve conter números e caracteres especiais",
    ),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Tipos"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Atualizar Endereço"),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Use códigos de estado com 2 letras (CA, NY, TX)\n• Use códigos de país com 2 letras (US, CA, GB)\n• Verifique o formato do CEP/código postal\n• Certifique-se de preencher todos os campos obrigatórios",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Você precisa fazer login para ver os endereços",
    ),
