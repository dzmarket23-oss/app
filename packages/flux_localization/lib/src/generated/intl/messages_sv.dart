...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(day) => "${day} dagar sedan";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "Slutar om ${timeLeft}";

  static String m23(captcha) => "Ange ${captcha} för att bekräfta:";

  static String m24(message) => "Fel: ${message}";

  static String m25(message) => "Fel: ${message}";

  static String m26(error) => "Ett fel inträffade: ${error}";

  static String m27(error) => "Ett fel inträffade: ${error}";

  static String m28(time) => "Går ut om ${time}";

  static String m29(total) => ">${total} km";

  static String m30(hour) => "${hour} timmar sedan";
  ...
  static String m34(size) => "Maximal filstorlek: ${size} MB";
  ...
  static String m37(count) => "Minst ${count} tecken krävs";
  ...
  static String m40(value) => "Minsta transaktion: ${value}";

  static String m41(minute) => "För ${minute} minuter sedan";

  static String m42(month) => "För ${month} månader sedan";

  static String m43(store) => "Mer från ${store}";

  static String m44(number) => "Måste köpas i grupper om ${number}";

  static String m45(itemCount) => "${itemCount} artiklar";

  static String m46(price) => "Totalt antal alternativ: ${price}";

  static String m47(amount) => "Betala ${amount}";

  static String m48(name) => "${name} har lagts till i kundvagnen";

  static String m49(total) => "Antal: ${total}";

  static String m50(name) => "Tog emot pengar från ${name}";

  static String m51(count) =>
      "Vill du ta bort ${count} artikel/artiklar från din önskelista?";

  static String m52(percent) => "Rea ${percent}%";

  static String m53(keyword) => "Sökresultat för: \'${keyword}\'";

  static String m54(keyword, count) => "${keyword} (${count} objekt)";

  static String m55(keyword, count) => "${keyword} (${count} objekt)";

  static String m56(second) => "För ${second} sekunder sedan";

  static String m57(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m58(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m59(price) => "Startar från ${price}";

  static String m60(fieldName) => "Fältet ${fieldName} är obligatoriskt";

  static String m61(total) => "${total} produkter";

  static String m62(name) => "Överför pengar till ${name}";

  static String m63(price) => "Upp till ${price}";

  static String m64(amount) => "Använd ${amount} poäng";
  ...
  static String m66(time) => "Giltig till: ${time}";

  static String m67(date) => "Giltig till ${date}";

  static String m68(number) => "Version ${number}";

  static String m69(balance) => "Plånbokssaldo: ${balance}";

  static String m70(message) => "Varning: ${message}";
  ...
  static String m72(length) => "Vi hittade ${length} produkter";

  static String m73(week) => "Vecka ${week}";

  static String m74(name) => "Välkommen ${name}";

  static String m75(year) => "För ${year} år sedan";

  static String m76(count) => "Du väljer ${count} artikel/artiklar";

  static String m77(total) => "Du har tilldelats order nr${total}";

  static String m78(type) => "Du har klarat ${type}";

  static String m79(point) => "Du har ${point} poäng";
